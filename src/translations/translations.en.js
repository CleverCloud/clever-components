...
export const translations = {
  ...
  'cc-domain-management.dns.desc': () => sanitize`<p>To associate a domain managed by a third-party provider to your Clever Cloud application, you need to configure its DNS zone.</p>
  ...
  'cc-domain-management.dns.info.apex': () => sanitize`For APEX domains or subdomains with an existing DNS zone, refer to our <a href="https://developers.clever-cloud.com/doc/administrate/domain-names/">DNS & Domains documentation</a>.`,
  ...
  'cc-domain-management.form.domain.error.contains-path': ({ path }) => `Enter the "${path}" part within the "Path" input field`,
  ...
  'cc-domain-management.form.domain.error.wildcard': () => sanitize`Enter a valid domain.<br>Wildcards "*" may only be used as subdomains like: "*.example.com"`,
  'cc-domain-management.form.domain.help': () => sanitize`For instance: <code>example.com</code>, <code>*.example.com</code> or <code>example.cleverapps.io</code>`,
  'cc-domain-management.form.domain.label': `Domain name`,
  'cc-domain-management.form.info.cleverapps': () => sanitize`If you need a domain name for testing purposes, you may use <code>my-website.cleverapps.io</code>`,
  'cc-domain-management.form.info.docs': () => sanitize`Associate a domain name to your application. For more information, refer to our documentation <a href="https://developers.clever-cloud.com/doc/administrate/domain-names/">Domain Names</a>.`,
  'cc-domain-management.form.info.primary': `You can choose a primary domain. Links to your application from within the console lead to this domain and emails about your application only mention this domain.`,
  ...
  'cc-domain-management.form.submit.error': ({ domain }) => `An error occurred while trying to add the "${domain}" domain.`,
  'cc-domain-management.form.submit.error-duplicate.heading': `Domain name not available`,
  'cc-domain-management.form.submit.error-duplicate.text': ({ domain }) => sanitize`<p>The "${domain}" domain is already associated to another application within Clever Cloud.</p>
  <p>For more information, contact our support team.</p>`,
  'cc-domain-management.form.submit.success': ({ domain }) => `The "${domain}" domain has been successfully associated to your application.`,
  'cc-domain-management.form.submit.success-config': ({ domain }) => sanitize`<p>The "${domain}" domain has been successfully associated to your application.</p>
  ...
  'cc-domain-management.list.delete.error': ({ domain }) => `Something went wrong while trying to delete the "${domain}" domain.`,
  'cc-domain-management.list.delete.success': ({ domain }) => `The "${domain}" domain has been deleted successfully.`,
  ...
  'cc-domain-management.list.error-not-found.text': ({ domain }) => sanitize`<p>The "${domain}" domain may have been removed by someone else after loading the list of domains.<p>
  ...
  'cc-domain-management.list.http-only.notice': () => sanitize`Subdomains are not covered by the SSL certificate of <code>*.cleverapps.io</code>. They do not support HTTPS.`,
  ...
  'cc-logs-application-view.progress.overflow.message': ({ limit }) => `To maintain optimal performance, only the last ${formatNumber(lang, limit)} logs are shown.`,
  'cc-logs-application-view.progress.overflow.message.almost': ({ limit }) => `You'll soon reach ${formatNumber(lang, limit)} logs loaded. What do you want to do?`,
