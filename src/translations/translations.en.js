...
export const translations = {
  ...
  'cc-oauth-consumer-info.access.title': `Your access`,
  'cc-oauth-consumer-info.error': `Something went wrong while loading OAuth consumer info.`,
  'cc-oauth-consumer-info.info.base-url': `API base URL`,
  'cc-oauth-consumer-info.info.description': `Here's what you need to know to identify and configure your application correctly.`,
  'cc-oauth-consumer-info.info.homepage-url': `Landing page URL`,
  'cc-oauth-consumer-info.info.key': `Key`,
  'cc-oauth-consumer-info.info.secret': `Secret`,
  'cc-oauth-consumer-info.info.title': `About you OAuth Consumer`,
  'cc-oauth-consumer-info.rights-title.access': `Give right to access`,
  'cc-oauth-consumer-info.rights-title.manage': `Give right to manage`,
  ...
  'cc-oauth-consumer-info.rights.description': `These are the authorizations granted and the data to which your application currently has access.`,
  ...
  'cc-oauth-consumer-info.rights.title': `Your authorizations`,
  //#endregion
