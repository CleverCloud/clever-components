...
export const translations = {
  ...
  'cc-oauth-consumer-form.auth.access.option.access-organisations': `Access my organizations`,
  'cc-oauth-consumer-form.auth.access.option.access-organisations-bills': `Access my organizations' bills`,
  'cc-oauth-consumer-form.auth.access.option.access-organisations-consumption-statistics': `Access my organizations' consumption statistics`,
  'cc-oauth-consumer-form.auth.access.option.access-organisations-credit-count': `Access my organizations' credit count`,
  'cc-oauth-consumer-form.auth.access.option.access-personal-information': `Access my personal information`,
  ...
  'cc-oauth-consumer-form.auth.manage.option.manage-organisations': `Manage my organizations`,
  'cc-oauth-consumer-form.auth.manage.option.manage-organisations-applications': `Manage my organizations' applications`,
  'cc-oauth-consumer-form.auth.manage.option.manage-organisations-members': `Manage my organizations' members`,
  'cc-oauth-consumer-form.auth.manage.option.manage-organisations-services': `Manage my organizations' add-ons`,
  ...
  'cc-oauth-consumer-form.button.reset': `Reset`,
  ...
  'cc-oauth-consumer-form.info.homepage-url.label': `Homepage URL`,
  'cc-oauth-consumer-form.info.image.label': `Application image`,
  'cc-oauth-consumer-form.info.name.label': `Name of your application`,
  'cc-oauth-consumer-form.info.place-holder': `No value yet...`,
  'cc-oauth-consumer-form.info.title': `Informations`,
  'cc-oauth-consumer-form.info.url.error.message': `Enter a valid url. Example: https://example.com`,
  //#endregion
