...
<p>This may be achieved using a <code>CNAME</code> or <code>A</code> records. We recommend using a <code>CNAME</code> record, as you won't have to reconfigure it if we change our IPs.</p>`,
  ...
  'cc-homepage-onboarding.card.cli.description': `Manage apps, scale resources, and streamline workflows directly from your terminal.`,
  ...
  'cc-homepage-onboarding.card.new-project.button': `Create new organisation`,
  'cc-homepage-onboarding.card.new-project.description': `Create a new organisation to group and launch applications, add-ons, databases, storage...`,
  'cc-homepage-onboarding.card.new-project.title': `Start new project`,
  'cc-homepage-onboarding.card.new-resource.button': `Add new resource`,
  'cc-homepage-onboarding.card.new-resource.description': `Add applications, add-ons, databases, storage...`,
  'cc-homepage-onboarding.card.new-resource.select.placeholder': `-- Select --`,
  'cc-homepage-onboarding.card.new-resource.select.title': `Choose an organisation`,
  'cc-homepage-onboarding.card.new-resource.title': `Launch new resource`,
  'cc-homepage-onboarding.card.secure.button': `Activate 2FA`,
  'cc-homepage-onboarding.card.secure.description': `Enhance your account security with 2FA, highly recommended to protect your access.`,
