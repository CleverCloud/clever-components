...
export const translations = {
  ...
  'cc-addon-credentials-beta.download-s3cfg-file': `Download a pre-filled s3cfg file`,
  ...
  'cc-addon-credentials-beta.renew-secret': `Renew secret`,
  //#endregion
...
<p>This may be achieved using a <code>CNAME</code> or <code>A</code> records. We recommend using a <code>CNAME</code> record, as you won't have to reconfigure it if we change our IPs.</p>`,
  ...
  'cc-network-group-dashboard.danger-zone.dialog.desc': `This Network Group will be permently deleted. All associated configurations will be lost. This cannot be undone.`,
  ...
  'cc-network-group-member-list.intro': `A member is a resource connected to a Network Group: it can be an application, an add-on, or even an external service. Each member has a dedicated domain name within the private network. A peer is an instance of this member, with a local IP. Peers in the same Network Group can communicate through an encrypted tunnel with each other on any port.`,
  ...
  'cc-network-group-member-list.member-list.empty': `You don't have any member or peer inside the Network Group`,
