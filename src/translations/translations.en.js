...
export const translations = {
  ...
  'cc-oauth-consumer-form.danger-zone.description': `Deleting this OAuth Consumer is permanent and cannot be undone. Once deleted, users will no longer be able to log in to your application via OAuth, and all granted permissions will be revoked.`,
  ...
  'cc-oauth-consumer-form.info.base-url': `Application base URL`,
  'cc-oauth-consumer-form.info.description': `This information will help identify and ensure seamless integration.`,
  'cc-oauth-consumer-form.info.description-input': `Description of your application`,
  'cc-oauth-consumer-form.info.homepage-url': `Application homepage URL`,
  'cc-oauth-consumer-form.info.image': `Application's picture`,
  'cc-oauth-consumer-form.info.name': `Application's name`,
  'cc-oauth-consumer-form.info.placeholder': `No value yet...`,
  'cc-oauth-consumer-form.info.title': `Main information`,
  'cc-oauth-consumer-form.info.url.error': `Enter valid url. Example: https://example.com`,
  'cc-oauth-consumer-form.reset-button': `Reset changes`,
  ...
  'cc-oauth-consumer-form.rights.description': `These permissions will define the actions users can take via OAuth and the data your application will have access to.`,
  ...
  'cc-oauth-consumer-form.update-button': `Save changes`,
  ...
  'cc-oauth-consumer-info.rights.description': `The consumer will ask access to the following rights:`,
