...
export const translations = {
  ...
  'cc-credit-consumption.disclaimer.content': () => sanitize`
    <p>Data displayed below is an <strong>assessment</strong> of your current consumption and credits.</p>
    <p>Amounts displayed here are <strong>tax excluded</strong>.</p>
  `,
  'cc-credit-consumption.disclaimer.heading': `This is not an invoice`,
  'cc-credit-consumption.error.loading': `Something went wrong while loading your consumption data.`,
  'cc-credit-consumption.header.discount': (discountNumber) => `Apply your ${discountNumber}% discount`,
  'cc-credit-consumption.legend.consumption': `Consumption`,
  'cc-credit-consumption.legend.credits': `Credits`,
  'cc-credit-consumption.legend.free': `Free credits`,
  'cc-credit-consumption.legend.prepaid': `Prepaid credits`,
  'cc-credit-consumption.legend.remaining': `Remaining credits`,
  'cc-credit-consumption.long-date': (date) => new Date(date).toLocaleDateString(lang, { year: 'numeric', month: 'long', day: 'numeric' }),
  'cc-credit-consumption.main-title': `Consumption assessment & Credits`,
  'cc-credit-consumption.overview.a11y-table-caption': `Counsumption and credit amounts`,
  'cc-credit-consumption.overview.consumption.desc': () => sanitize`<p>Assessment of the runtime cost related to all your applications and add-ons created from the console. These products are billed by second of runtime to reflect your actual usuage.</p>
  <p>The consumption data <strong>only includes packaged products from the Clever Cloud console</strong>. Additional costs related to products subscribed with our support team are not not part of what is detailed here.</p>
  <p>For more information, go to our <a href="https://www.clever-cloud.com/pricing/">Pricing</a> page.</p>`,
  'cc-credit-consumption.overview.consumption.legend': `Assessed consumption until yesterday at midnight (UTC)`,
  'cc-credit-consumption.overview.consumption.title': `Consumption`,
  'cc-credit-consumption.overview.credits-with-prepaid.desc': () => sanitize`<p>The total of credits at the beginning of the period is made of your free credits and prepaid credits.</p>
  <p>Free credits are generated by summing up your active vouchers. These credits are consumed first.</p>
  <p>Prepaid credits correspond to an amount that you have payed upfront. This amount is based on your consumption during your last billing cycle.</p>
  <p>The remaining credits amount is assessed by substracting you current consumption from the total of credits available for the period.</p>
  `,
  'cc-credit-consumption.overview.credits.legend.remaining': `Remaining credits`,
  'cc-credit-consumption.overview.credits.legend.total': `Total for the current billing cycle`,
  'cc-credit-consumption.overview.credits.title': `Remaining credits`,
  'cc-credit-consumption.overview.docs': `What are you going to pay?`,
  'cc-credit-consumption.overview.free-credits-only.desc': () => sanitize`<p>Since you have chosen to disable prepaid credits, the amount above is only made of your free credits.</p>
  <p>This amount is equal to the sum from your active vouchers for the current billing cycle.</p>
  <p>For more information, please refer to the "Free credits" section below.</p>`,
  'cc-credit-consumption.overview.suborg.desc': ({ name, id }) => sanitize`
    <p>Your organization is attached to the following organization: <a href="/organisations/${id}">${name}</a>.</p>
    <p>This means free and prepaid credits belong to this organization instead of yours.</p>
    <p>The consumption amount of your organization is integrated into the ${name} organization own consumption data.</p>
    <p>This means your organization will not be invoiced as long as it is attached to another organization.</p>
  `,
  'cc-credit-consumption.overview.suborg.title': `Your organization is attached to another`,
  'cc-credit-consumption.period.active': ({ startDate, endDate }) => {
    ...
    return sanitize`Displayed period: from <strong>${formattedStartDate}</strong> to <strong>${formattedEndDate}</strong>`;
  },
  'cc-credit-consumption.period.current': `Show data from the current month`,
  'cc-credit-consumption.period.prev': `Show data from the previous month`,
  ...
  'cc-credit-consumption.update-date': (date) => {
    ...
    return sanitize`Data updated on <strong>${formattedDate}</strong>`;
  },
  //#endregion
  ...
  'cc-email-list.secondary.description': `Unlike the primary email address, no notifications are sent to these addresses. You can be invited inside an organization with any of your secondary email addresses.`,
  ...
  'cc-free-credits.add': `Add a voucher`,
  'cc-free-credits.empty': `You have no active voucher for this period.`,
  'cc-free-credits.error.empty': `Please enter a coupon value`,
  'cc-free-credits.input.label': `Voucher code`,
  'cc-free-credits.list.activation-date': `Activation date: `,
  'cc-free-credits.list.amount': `Amount: `,
  'cc-free-credits.list.expiration-date': `Expiration date: `,
  'cc-free-credits.list.origin': `Origin: `,
  ...
  'cc-free-credits.reason.account-creation': `Welcome voucher`,
  'cc-free-credits.reason.conference': `Conference`,
  'cc-free-credits.table.activation-date': `Activation date`,
  'cc-free-credits.table.amount': `Amount`,
  'cc-free-credits.table.caption': `Details about your free credit vouchers`,
  'cc-free-credits.table.expiration-date': `Expiration date`,
  'cc-free-credits.table.origin': `Origin`,
  'cc-free-credits.title': `Free credits`,
  //#endregion
