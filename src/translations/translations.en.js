...
export const translations = {
  ...
  'cc-oauth-consumer.auth': `Your authorizations`,
  'cc-oauth-consumer.auth.access': `Access`,
  'cc-oauth-consumer.auth.access.option.access-organisations': `Access my organizations`,
  'cc-oauth-consumer.auth.access.option.access-organisations-bills': `Access my organizations' bills`,
  'cc-oauth-consumer.auth.access.option.access-organisations-consumption-statistics': `Access my organizations' consumption statistics`,
  ...
  'cc-oauth-consumer.auth.manage.option.manage-organisations-services': `Manage my organizations' add-ons`,
  'cc-oauth-consumer.auth.manage.option.manage-personal-information': `Manage my personal informations`,
  'cc-oauth-consumer.auth.manage.option.manage-ssh-keys': `Manage my ssh keys`,
  'cc-oauth-consumer.info.access': `Your access details`,
  'cc-oauth-consumer.info.base-url': `Application base URL`,
  'cc-oauth-consumer.info.homepage-url': `Homepage URL`,
  'cc-oauth-consumer.info.key': `Key`,
