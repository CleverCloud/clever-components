...
export const translations = {
  //#region cc-addon-access-items
  'cc-addon-access-items.code.api-client-secret': `API client secret`,
  'cc-addon-access-items.code.api-client-user': `API client user`,
  'cc-addon-access-items.code.api-key': `API key`,
  'cc-addon-access-items.code.api-password': `API password`,
  'cc-addon-access-items.code.api-url': `API URL`,
  'cc-addon-access-items.code.cluster-full-name': `Cluster full name`,
  'cc-addon-access-items.code.database-name': `Database name`,
  'cc-addon-access-items.code.direct-host': `Direct host`,
  'cc-addon-access-items.code.direct-port': `Direct port`,
  'cc-addon-access-items.code.direct-uri': `Direct URI`,
  'cc-addon-access-items.code.host': `Host`,
  'cc-addon-access-items.code.initial-password': `Initial password`,
  'cc-addon-access-items.code.network-group': `Network group`,
  'cc-addon-access-items.code.password': `Password`,
  'cc-addon-access-items.code.port': `Port`,
  'cc-addon-access-items.code.tenant': `Tenant`,
  'cc-addon-access-items.code.token': `Token`,
  'cc-addon-access-items.code.uri': `URI`,
  'cc-addon-access-items.code.user': `User`,
  'cc-addon-access-items.ng.disable': `Disable`,
  'cc-addon-access-items.ng.enable': `Enable Network Groups`,
  //#endregion
  //#region cc-addon-access-unique
  'cc-addon-access-unique.choice.api': `API`,
  'cc-addon-access-unique.choice.apm': `APM`,
  'cc-addon-access-unique.choice.default': `Default`,
