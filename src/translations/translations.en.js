...
export const translations = {
  ...
  'cc-session-tokens.revoke-all-tokens.error': `Something went wrong while revoking all sessions.`,
  'cc-session-tokens.revoke-all-tokens.partial-error': `Something went wrong while revoking all sessions. Only some sessions have been revoked successfully.`,
