...
export const translations = {
  ...
  'cc-addon-credentials-beta.cli.ng.intro': `Manage Network Group with the CLI`,
  'cc-addon-credentials-beta.cli.ng.manage.heading': `Manage Network Group versions`,
  'cc-addon-credentials-beta.cli.ng.view.command': () => sanitize`clever addon network-group show <addon_id>`,
  'cc-addon-credentials-beta.cli.ng.view.heading': `View Network Group`,
  'cc-addon-credentials-beta.cli.version.check': () => sanitize`clever addon network-group <enable|disable> <addon_id>`,
