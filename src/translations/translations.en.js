...
export const translations = {
  ...
  //#endregion
  //#region cc-email
  'cc-email.loading.error': `Something went wrong while loading email addresses.`,
  'cc-email.primary.action.resend-confirmation-email': `Resend a confirmation email`,
  'cc-email.primary.action.resend-confirmation-email.error': `Something went wrong while sending the confirmation email.`,
  'cc-email.primary.action.resend-confirmation-email.success.message': ({ address }) => sanitize`To complete the process, you must click on the link that has been sent to you by email at <code>${address}</code>.`,
  'cc-email.primary.action.resend-confirmation-email.success.title': `A confirmation email has been sent`,
  ...
  'cc-email.secondary.action.add': `Add email address`,
  'cc-email.secondary.action.add.error': `Something went wrong while adding the secondary email address.`,
  'cc-email.secondary.action.add.success.message': ({ address }) => sanitize`To complete the process you must confirm your registration by clicking on the link that was sent to you by e-mail at <code>${address}</code>.`,
  'cc-email.secondary.action.add.success.title': `Secondary email address addition has been taken into account`,
  'cc-email.secondary.action.delete': `Delete`,
  'cc-email.secondary.action.delete.error': `Something went wrong while deleting secondary email address.`,
  'cc-email.secondary.action.delete.success': `Secondary email address deleted successfully.`,
  'cc-email.secondary.action.mark-as-primary': `Mark as primary`,
  'cc-email.secondary.action.mark-as-primary.error': `Something went wrong while marking secondary email address as primary.`,
  'cc-email.secondary.action.mark-as-primary.success': `Secondary email address has been successfully marked as primary.`,
  'cc-email.secondary.address-input.error.already-defined': `This email address already belongs to you`,
  'cc-email.secondary.address-input.error.empty': `You must enter an email address`,
  'cc-email.secondary.address-input.error.invalid': () => sanitize`Invalid email address format.<br>Example: john.doe@example.com.`,
  'cc-email.secondary.address-input.error.used': `This email address does not belong to you`,
  'cc-email.secondary.address-input.format': `name@domain.com`,
  'cc-email.secondary.address-input.label': `Email address`,
  'cc-email.secondary.description': `Unlike the primary email address, no notifications is sent to these addresses. Secondary email address can be used when adding someone to the list of members of an organisation.`,
  'cc-email.secondary.title': `Secondary email addresses`,
  'cc-email.title': `Email addresses`,
  //#endregion
