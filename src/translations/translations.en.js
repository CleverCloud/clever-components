...
export const translations = {
  ...
  'cc-logs-application-view.custom-date-range.since': `Since`,
  'cc-logs-application-view.custom-date-range.until': `Until`,
  ...
  'cc-logs-application-view.date-selection.live': `Live tail`,
  ...
  'cc-logs-application-view.logs.loading': `Loading logs`,
  ...
  'cc-logs-application-view.progress.loading.live': `Loading logs`,
  'cc-logs-application-view.progress.message': ({ count }) => `${formatNumber(lang, count)} log entries loaded.`,
  'cc-logs-application-view.progress.overflow.continue': `Continue`,
  'cc-logs-application-view.progress.overflow.message': ({ limit }) => `The maximum number of logs has been exceeded. You only see the last ${formatNumber(lang, limit)} logs.`,
  'cc-logs-application-view.progress.overflow.message.almost': `The maximum number of logs will soon be exceeded. What do you want to do?`,
  'cc-logs-application-view.progress.overflow.stop': `Stop`,
  'cc-logs-application-view.progress.overflow.title': `Overflow`,
