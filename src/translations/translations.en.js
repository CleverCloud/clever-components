...
export const translations = {
  ...
  'cc-kv-explorer.key.delete': `Delete the key`,
  ...
  'cc-kv-explorer.keys.empty.create-key': `Let's create a new key!`,
  ...
  'cc-kv-explorer.keys.header.total': /** @param {{total: number}} _ */ ({ total }) =>
    `Number of keys: ${formatNumber(lang, total)}`,
  ...
  'cc-kv-hash-explorer.element.copy': `Copy value to clipboard`,
  'cc-kv-hash-explorer.element.delete': `Delete the field`,
  'cc-kv-hash-explorer.element.edit.cancel': `Cancel value edition`,
  'cc-kv-hash-explorer.element.edit.save': `Update the value`,
  'cc-kv-hash-explorer.element.edit.start': `Edit the value`,
  ...
  'cc-kv-hash-input.element.add': `Add the field`,
  'cc-kv-hash-input.element.delete': `Remove the field`,
  ...
  'cc-kv-list-input.element.add': `Add the element`,
  'cc-kv-list-input.element.delete': `Remove the element`,
  ...
  'cc-kv-set-explorer.element.copy': `Copy value to clipboard`,
  'cc-kv-set-explorer.element.delete': `Delete the member`,
