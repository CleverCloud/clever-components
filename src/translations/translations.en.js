...
export const translations = {
  ...
  'cc-token-api-creation-form.validation-step.form.error.credentials.password-only': `Invalid password`,
  'cc-token-api-creation-form.validation-step.form.error.credentials.with-mfa': `Invalid password or 2FA code`,
