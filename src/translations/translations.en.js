...
export const translations = {
  ...
  'cc-addon-credentials-beta.ng.enabling.error': `Something went wrong while trying to enable the Network Group`,
  'cc-addon-credentials-beta.ng.enabling.success': `The Network Group has been successfully enabled`,
  //#endregion
  ...
  'cc-addon-credentials-content.ng.enable': `Enable the Network Group`,
  //#endregion
  ...
  'cc-addon-header.rebuild.success.message': /** @param {{logsUrl: string, docName: string}} _ */ ({
    logsUrl,
    docName,
  }) =>
    sanitize`The process of rebuilding and restarting your add-on and its linked services is in progress. See the <cc-link href="${logsUrl}">logs</cc-link> or the <cc-link href="${generateDocsHref(`/addons/${docName}/`)}">documentation</cc-link> for more information.`,
  ...
  'cc-addon-header.restart.success.message': /** @param {{logsUrl: string, docName: string}} _ */ ({
    logsUrl,
    docName,
  }) =>
    sanitize`The process of restarting your add-on and its linked services is in progress. See the <cc-link href="${logsUrl}">logs</cc-link> or the <cc-link href="${generateDocsHref(`/addons/${docName}/`)}">documentation</cc-link> for more information.`,
