...
export const translations = {
  ...
  'cc-cellar-bucket-list.create.bucket-name.help.size': `Bucket names can be between 3 and 63 characters long.`,
  ...
  'cc-cellar-bucket-list.create.error.bucket-already-exists': `The bucket already exists`,
