...
export const translations = {
  ...
  'cc-addon-admin.delete-vm': `The database is kept for 24 hours.`,
  'cc-addon-admin.delete-vm-and-backups': `The database is kept for 24 hours, backups according to the retention policy.`,
