...
export const translations = {
  ...
  'cc-addon-encryption-at-rest-option.description': () =>
    sanitize`Encryption at rest encrypts the entire data disk of your add-on. It prevents reading the stored data in case of a physical access to the hard drive. More information in our <a href="https://www.clever-cloud.com/developers/doc/administrate/encryption-at-rest/">documentation</a>.`,
  ...
  'cc-env-var-editor-expert.example': () =>
    sanitize`Format: <code>VARIABLE_NAME="variable value"</code> <br> Every variable must be separated by a line break, <a href="https://www.clever-cloud.com/developers/doc/develop/env-variables/#format">learn more</a>.`,
  ...
  'cc-env-var-form.description.config-provider': /** @param {{addonName: string}} _ */ ({ addonName }) =>
    sanitize`Configuration exposed to dependent applications. <a href="https://www.clever-cloud.com/developers/doc/deploy/addon/config-provider/">Learn more</a><br>These variables will be injected as environment variables in applications that have the add-on <strong>${addonName}</strong> in their service dependencies.<br>Every time you update your changes, all the dependent applications will be automatically restarted.`,
  ...
  'cc-oauth-consumer-info.rights.edit': `Edit the informations`,
  ...
  'cc-oauth-consumer-info.rights.manage-personal-information': `Personal informations`,
  ...
  'cc-orga-member-list.invite.info': () =>
    sanitize`More information about roles in the <a href="https://www.clever-cloud.com/developers/doc/account/organizations/#roles-and-privileges">Roles and Organisations</a> page.`,
