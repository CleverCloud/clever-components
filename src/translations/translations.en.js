...
export const translations = {
  ...
  'cc-email.primary.action.resend-confirmation-email.success.message': `To finish the subscription process, you must click on the link that has been sent to you by email.`,
  'cc-email.primary.action.resend-confirmation-email.success.title': ({ address }) => sanitize`A confirmation email has been sent to <code>${address}</code>.`,
  ...
  'cc-email.secondary.action.add.success': `Secondary email address added successfully.`,
