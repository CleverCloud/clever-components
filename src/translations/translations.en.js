...
export const translations = {
  ...
  'cc-oauth-consumer-form.danger-zone.description': `Deleting this OAuth consumer is permanent and cannot be undone. Once deleted, users will no longer be able to log in to the application via OAuth, and all granted rights will be revoked.`,
  'cc-oauth-consumer-form.danger-zone.title': /** @param {{oauthConsumerName: string}} _ */ ({ oauthConsumerName }) =>
    `Delete OAuth consumer (${oauthConsumerName})`,
  ...
  'cc-oauth-consumer-form.go-back-link': `Go back`,
  'cc-oauth-consumer-form.info.base-url': `Base URL`,
  'cc-oauth-consumer-form.info.base-url.help': `The base URL to be used for OAuth redirects.`,
  'cc-oauth-consumer-form.info.description': `The OAuth consumer requires the application details so it can redirect the users appropriately.`,
  'cc-oauth-consumer-form.info.description-input': `Description`,
  'cc-oauth-consumer-form.info.description.help': `This description will be displayed to all users of your application.`,
  'cc-oauth-consumer-form.info.homepage-url': `Homepage URL`,
  'cc-oauth-consumer-form.info.homepage-url.help': `The full URL to your application homepage.`,
  'cc-oauth-consumer-form.info.image': `Logo URL`,
  'cc-oauth-consumer-form.info.image.help': `This image will be displayed to users when they request authorization, making it easier for them to recognize your service.`,
  ...
  'cc-oauth-consumer-form.rights.description': `The OAuth consumer will prompt the application users for the following rights:`,
