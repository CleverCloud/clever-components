...
export const translations = {
  ...
  'cc-kv-explorer.key.delete': `Supprimer la clé`,
  ...
  'cc-kv-explorer.keys.header.total': /** @param {{total: number}} _ */ ({ total }) =>
    `Nombre de clés : ${formatNumber(lang, total)}`,
  ...
  'cc-kv-hash-explorer.element.copy': `Copier la valeur dans le presse-papier`,
  'cc-kv-hash-explorer.element.delete': `Supprimer le champ`,
  ...
  'cc-kv-hash-explorer.element.edit.start': `Editer la valeur`,
  ...
  'cc-kv-hash-input.element.add': `Ajouter le champ`,
  'cc-kv-hash-input.element.delete': `Enlever le champ`,
  ...
  'cc-kv-list-explorer.add-form.element-position.tail': `A la fin`,
  'cc-kv-list-explorer.add-form.element-value': `Elément`,
  'cc-kv-list-explorer.add-form.submit': `Ajouter`,
  'cc-kv-list-explorer.add-form.submit.a11y': `Ajouter l'élément`,
  'cc-kv-list-explorer.element.copy': `Copier la valeur dans le presse-papier`,
  ...
  'cc-kv-list-explorer.element.edit.start': `Editer l'élément`,
  ...
  'cc-kv-list-explorer.header.value': `Elément`,
  ...
  'cc-kv-list-input.element.add': `Ajouter l'élément`,
  'cc-kv-list-input.element.delete': `Enlever l'élément`,
  'cc-kv-list-input.element.value-input': `Elément`,
  'cc-kv-list-input.header.elements': `Eléments`,
  //#endregion
  ...
  'cc-kv-set-explorer.element.copy': `Copier la valeur dans le presse-papier`,
  'cc-kv-set-explorer.element.delete': `Supprimer le membre`,
