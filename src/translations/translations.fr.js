...
export const translations = {
  ...
  'cc-token-oauth-list.card.deadline-approaches': `Expire bientôt`,
  ...
  'cc-token-oauth-list.empty': `Aucune application tierce liée à votre compte.`,
  'cc-token-oauth-list.error': `Une erreur est survenue pendant le chargement des tokens OAuth.`,
  'cc-token-oauth-list.intro': `Ci-dessous figure la liste de tous les tokens OAuth enregistrés pour votre compte. Vous pouvez les révoquer comme vous le souhaitez.`,
  ...
  'cc-token-session-list.card.deadline-approaches': `Expire bientôt`,
  ...
  'cc-token-session-list.intro': `Ci-dessous figure la liste de toutes les sessions enregistrées pour votre compte. Vous pouvez les révoquer comme vous le souhaitez.`,
