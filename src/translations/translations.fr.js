...
export const translations = {
  ...
  'cc-network-group-linked-resources.member-list.empty': `Aucun membre n'est lié à ce Network Group`,
  'cc-network-group-linked-resources.member.nb-of-peers': /** @param {{ nbOfPeers: number}} _ */ ({ nbOfPeers }) =>
    `${nbOfPeers} ${plural(nbOfPeers, 'pair')}`,
  'cc-network-group-linked-resources.member.unlink': `Délier le membre`,
