...
export const translations = {
  ...
  'cc-email.primary.action.resend-confirmation-email.success.message': `Pour terminer le processus vous devez confirmer votre inscription en cliquant sur le lien qui vous a été envoyé par e-mail.`,
  'cc-email.primary.action.resend-confirmation-email.success.title': ({ address }) => sanitize`Un e-mail de confirmation a été envoyé à l'adresse <code>${address}</code>.`,
  ...
  'cc-email.secondary.action.add.success': ({ address }) => sanitize`Un e-mail de confirmation a été envoyé à l'adresse <code>${address}</code>.`,
