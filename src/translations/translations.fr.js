...
export const translations = {
  ...
  'cc-network-group-dashboard.danger-zone.dialog.desc': `Le Network Group sera supprimé de manière définitive. Toutes les configurations associées seront également perdues. Cette action est irreversible.`,
  ...
  'cc-network-group-member-list.intro': `Un membre est une ressource connectée à un Network Group : cela peut être une application, un module complémentaire ou même un service externe. Chaque membre possède un nom de domaine dédié au sein du réseau privé. Un pair est une instance de ce membre, avec une addresse IP locale. Les pairs d'un même Network Group peuvent communiquer entre eux sur n'importe quel port grâce à un tunnel chiffré.`,
  ...
  'cc-network-group-member-list.member-list.empty': `Il n'y a aucun membre ou pair dans ce Network Group`,
