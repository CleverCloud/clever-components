...
export const translations = {
  ...
  'cc-addon-header.rebuild.success.message': /** @param {{logsUrl: string, docName: string}} _ */ ({
    ...
    sanitize`Le processus de re-build et de redémarrage de votre add-on et de ses services associés est en cours.  Consultez les <cc-link href="${logsUrl}">logs</cc-link> ou la <cc-link href="${generateDocsHref(`/addons/${docName}/`)}">documentation</cc-link> pour plus d'informations.`,
  ...
  'cc-addon-header.restart.success.message': /** @param {{logsUrl: string, docName: string}} _ */ ({
    ...
    sanitize`Le processus de redémarrage de votre add-on et de ses services associés est en cours. Consultez les <cc-link href="${logsUrl}">logs</cc-link> ou la <cc-link href="${generateDocsHref(`/addons/${docName}/`)}">documentation</cc-link> pour plus d'informations.`,
