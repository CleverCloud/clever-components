...
export const translations = {
  ...
  'cc-oauth-consumer-info.access.title': `Vos accès`,
  'cc-oauth-consumer-info.error': `Une erreur est survenue pendant le chargement des informations du consumer OAuth .`,
  'cc-oauth-consumer-info.info.base-url': `Url de base de l'API`,
  'cc-oauth-consumer-info.info.description': `Voici les informations importantes pour identifier et configurer correctement votre application.`,
  ...
  'cc-oauth-consumer-info.info.title': `A propos de votre OAuth Consumer`,
  'cc-oauth-consumer-info.rights-title.access': `Donner le droit d'accéder`,
  'cc-oauth-consumer-info.rights-title.manage': `Donner le droit de gérer`,
  'cc-oauth-consumer-info.rights.access-organisations': `Organisations`,
  'cc-oauth-consumer-info.rights.access-organisations-bills': `Factures de mes organisations`,
  'cc-oauth-consumer-info.rights.access-organisations-consumption-statistics': `Statistiques de consommation de mes organisations`,
  'cc-oauth-consumer-info.rights.access-organisations-credit-count': `Nombre de crédits de mes organisations`,
  ...
  'cc-oauth-consumer-info.rights.description': `Voici les autorisations accordées et des données auxquelles votre application a actuellement accès.`,
  'cc-oauth-consumer-info.rights.edit': `Editer les informations`,
  'cc-oauth-consumer-info.rights.manage-organisations': `Organisations`,
  'cc-oauth-consumer-info.rights.manage-organisations-applications': `Applications de mes organisations`,
  'cc-oauth-consumer-info.rights.manage-organisations-members': `Membres de mes organisations`,
  'cc-oauth-consumer-info.rights.manage-organisations-services': `Add-ons de mes organisations`,
