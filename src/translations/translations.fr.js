...
export const translations = {
  ...
  //#endregion
  //#region cc-email
  'cc-email.loading.error': `Une erreur est survenue pendant le chargement des adresses e-mail.`,
  'cc-email.primary.action.resend-confirmation-email': `Envoyer un nouvel e-mail de confirmation`,
  'cc-email.primary.action.resend-confirmation-email.error': `Une erreur est survenue pendant l'envoie de l'e-mail de confirmation.`,
  'cc-email.primary.action.resend-confirmation-email.success.message': ({ address }) => sanitize`Pour terminer le processus vous devez confirmer votre inscription en cliquant sur le lien qui vous a été envoyé par e-mail à l'adresse <code>${address}</code>.`,
  'cc-email.primary.action.resend-confirmation-email.success.title': `Un e-mail de confirmation a été envoyé.`,
  'cc-email.primary.description': `Cette adresse est celle utilisée pour la création de votre compte. Toutes les notifications sont envoyées à cette adresse.`,
  'cc-email.primary.email.unverified': `Non vérifiée`,
  'cc-email.primary.email.verified': `Vérifiée`,
  'cc-email.primary.title': `Adresse e-mail principale`,
  'cc-email.secondary.action.add': `Ajouter l'adresse`,
  'cc-email.secondary.action.add.error': `Une erreur est survenue lors de l'ajout de l'adresse e-mail secondaire.`,
  'cc-email.secondary.action.add.success.message': ({ address }) => sanitize`Pour terminer le processus vous devez confirmer votre inscription en cliquant sur le lien qui vous a été envoyé par e-mail à l'adresse <code>${address}</code>.`,
  'cc-email.secondary.action.add.success.title': `L'ajout d'adresse e-mail secondaire a été pris en compte`,
  'cc-email.secondary.action.delete': `Supprimer`,
  'cc-email.secondary.action.delete.error': `Une erreur est survenue lors de la suppression de l'adresse e-mail secondaire.`,
  'cc-email.secondary.action.delete.success': `L'adresse e-mail secondaire a été supprimée avec succès.`,
  'cc-email.secondary.action.mark-as-primary': `Marquer comme primaire`,
  'cc-email.secondary.action.mark-as-primary.error': `Une erreur est survenue pendant le marquage en tant qu'adresse e-mail primaire.`,
  'cc-email.secondary.action.mark-as-primary.success': `L'adresse e-mail a bien été marquée comme primaire.'`,
  'cc-email.secondary.address-input.error.already-defined': `Cette adresse e-mail vous appartient déjà`,
  'cc-email.secondary.address-input.error.empty': `Veuillez saisir une adresse e-mail`,
  'cc-email.secondary.address-input.error.invalid': () => sanitize`Format d'adresse e-mail invalide.<br>Exemple: john.doe@example.com.`,
  'cc-email.secondary.address-input.error.used': `Cette address e-mail ne vous appartient pas`,
  'cc-email.secondary.address-input.format': `nom@domaine.com`,
  'cc-email.secondary.address-input.label': `Adresse e-mail`,
  'cc-email.secondary.description': `Contrairement à l'adresse principale, ces adresses e-mail ne recoivent aucune notification. Les adresses e-mail secondaires peuvent être utilisées pour ajouter un membre à une organisation.`,
  'cc-email.secondary.title': `Adresses e-mail secondaires`,
  'cc-email.title': `Adresses e-mail`,
  //#endregion
