...
export const translations = {
  ...
  'cc-addon-credentials-beta.cli.ng.intro': `Vous pouvez gérer le Network Group avec la CLI Clever Cloud :`,
  'cc-addon-credentials-beta.cli.ng.manage.command': () => sanitize`clever addon network-group <enable|disable> <addon_id>`,
  'cc-addon-credentials-beta.cli.ng.manage.heading': `Gérer le Network Group`,
  'cc-addon-credentials-beta.cli.ng.view.command': () => sanitize`clever addon network-group show <addon_id>`,
  'cc-addon-credentials-beta.cli.ng.view.heading': `Voir le Network Group`,
