...
export const translations = {
  ...
  //#endregion
  //#region cc-oauth-consumer-info-form
  ...
  'cc-oauth-consumer-form.button.delete': `Supprimer`,
  'cc-oauth-consumer-form.button.reset': `Annuler`,
  'cc-oauth-consumer-form.button.update': `Mettre à jour`,
  'cc-oauth-consumer-form.danger-zone': `Zone danger`,
  'cc-oauth-consumer-form.info.base-url.label': `Base url de l'application`,
  'cc-oauth-consumer-form.info.description.label': `Description de votre application`,
  'cc-oauth-consumer-form.info.homepage-url.label': `Page d'accueil de l'application`,
  'cc-oauth-consumer-form.info.image.label': `Image de l'application`,
  'cc-oauth-consumer-form.info.name.label': `Nom de votre application`,
  ...
  'cc-oauth-consumer-info.info.key': `Clé`,
  'cc-oauth-consumer-info.info.secret': `Secret`,
  'cc-oauth-consumer-info.info.title': `Vos informations d'accès`,
  'cc-oauth-consumer-info.rights-title.access': `Accès`,
  'cc-oauth-consumer-info.rights-title.manage': `Gestion`,
  'cc-oauth-consumer-info.rights.access-organisations': `A mes organisations`,
  'cc-oauth-consumer-info.rights.access-organisations-bills': `Aux factures de mes organisations`,
  'cc-oauth-consumer-info.rights.access-organisations-consumption-statistics': `Aux statistiques de consommation de mes organisations`,
  'cc-oauth-consumer-info.rights.access-organisations-credit-count': `Au nombre de crédits de mes organisations`,
  'cc-oauth-consumer-info.rights.access-personal-information': `A mes informations personnelles`,
  'cc-oauth-consumer-info.rights.almighty': `Almighty`,
  'cc-oauth-consumer-info.rights.edit': `Modifier les informations`,
  'cc-oauth-consumer-info.rights.manage-organisations': `Mes organisations`,
  'cc-oauth-consumer-info.rights.manage-organisations-applications': `Les applications de mes organisations`,
  'cc-oauth-consumer-info.rights.manage-organisations-members': `Les membres de mes organisations`,
  'cc-oauth-consumer-info.rights.manage-organisations-services': `Les add-ons de mes organisations`,
  'cc-oauth-consumer-info.rights.manage-personal-information': `Mes informations personnelles`,
  'cc-oauth-consumer-info.rights.manage-ssh-keys': `Mes clés SSH`,
  'cc-oauth-consumer-info.rights.title': `Vos autorisations`,
  //#endregion
