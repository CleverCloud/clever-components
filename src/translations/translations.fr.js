...
export const translations = {
  ...
  'cc-token-api-creation-form.copy-step.description': `Félicitations, votre token est maintenant créé ! Voici le token à conserver pour pouvoir l'utiliser. Elle vous permettra d'autoriser de façon sécurisée et sélective des applications à accéder à vos services.`,
  ...
  'cc-token-api-creation-form.copy-step.notice.message': () =>
    sanitize`Attention&nbsp;: Pour des raisons de sécurité, ce token d'API ne sera affichée qu'une seule fois. Assurez-vous de la copier et de la conserver dans un endroit sûr dès maintenant. Après sa création, vous ne pourrez plus la récupérer. Si vous perdez ce token, vous devrez en créer une nouvelle.`,
