...
export const translations = {
  ...
  'cc-logs-application-view.custom-date-range.since': `Début`,
  'cc-logs-application-view.custom-date-range.until': `Fin`,
  ...
  'cc-logs-application-view.date-selection.live': `Temps réel`,
  ...
  'cc-logs-application-view.logs.loading': `Chargement des logs`,
  ...
  'cc-logs-application-view.logs.warning.waiting.message': `Les logs émis par l'application apparaitront ici.`,
  ...
  'cc-logs-application-view.progress.loading.live': `Chargement des logs`,
  ...
  'cc-logs-application-view.progress.overflow.message': ({ limit }) => `Le nombre maximum de logs est dépassé. Vous ne voyez que les ${formatNumber(lang, limit)} derniers logs.`,
  'cc-logs-application-view.progress.overflow.message.almost': `Le nombre maximum de logs qui peuvent être affichés va bientôt être dépassé. Que voulez-vous faire ?`,
  'cc-logs-application-view.progress.overflow.stop': `Arrêter`,
  'cc-logs-application-view.progress.overflow.title': `Dépassement`,
