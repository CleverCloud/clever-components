...
export const translations = {
  ...
  'cc-email.primary.action.resend-confirmation-email.success': ({ address }) => sanitize`Un e-mail de confirmation a été envoyé à l'adresse <code>${address}</code>.`,
  ...
  // TODO: add procedure for confirmation
