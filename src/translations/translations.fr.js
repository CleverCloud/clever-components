...
export const translations = {
  ...
  'cc-addon-access-items.code.api-client-secret': `Secret du client API`,
  'cc-addon-access-items.code.api-client-user': `Utilisateur du client API`,
  'cc-addon-access-items.code.api-key': `Clé API`,
  'cc-addon-access-items.code.api-password': `Mot de passe API`,
  'cc-addon-access-items.code.api-url': `URL de l'API`,
  'cc-addon-access-items.code.cluster-full-name': `Nom complet du cluster`,
  'cc-addon-access-items.code.database-name': `Nom de la base de données`,
  'cc-addon-access-items.code.direct-host': `Hôte direct`,
  'cc-addon-access-items.code.direct-port': `Port direct`,
  'cc-addon-access-items.code.direct-uri': `URI directe`,
  'cc-addon-access-items.code.host': `Hôte`,
  'cc-addon-access-items.code.initial-password': `Mot de passe initial`,
  'cc-addon-access-items.code.network-group': `Network Group`,
  'cc-addon-access-items.code.password': `Mot de passe`,
  'cc-addon-access-items.code.port': `Port`,
  'cc-addon-access-items.code.tenant': `Tenant`,
  'cc-addon-access-items.code.token': `Jeton`,
  'cc-addon-access-items.code.uri': `URI`,
  'cc-addon-access-items.code.user': `Utilisateur`,
  'cc-addon-access-items.ng.disable': `Désactiver`,
  ...
  'cc-addon-access-unique.choice.default': `Par défaut`,
