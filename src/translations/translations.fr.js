...
export const translations = {
  ...
  'cc-addon-admin.delete.dialog.desc': `En supprimant cet add-on, vous risquez de perdre toutes ses données. Veuillez consulter les conditions générales d'utilisation de l'add-on provider pour plus d'informations.`,
  ...
  'cc-addon-info.role.primary': `Primaire`,
  'cc-addon-info.role.replica': `Réplica`,
  ...
  'cc-homepage-onboarding.card.cli.description': `Gérez les applications, services, faites évoluer les ressources et rationalisez les flux de travail directement depuis votre terminal.`,
  ...
  'cc-homepage-onboarding.card.first-resource.button': `Créer une ressource`,
  'cc-homepage-onboarding.card.first-resource.description': `Ajoutez des applications, add-ons, bases de données, stockage...`,
  'cc-homepage-onboarding.card.first-resource.title': `Déployez votre première ressource`,
  ...
  'cc-homepage-onboarding.card.new-resource.description': `Déployez des applications, add-ons, bases de données, stockage...`,
  ...
  'cc-homepage-onboarding.card.secure.description': `Améliorez la sécurité de votre compte avec la double authentification (2FA), fortement recommandée pour protéger votre accès.`,
  ...
  'cc-homepage-onboarding.description.new-user': `Commencez par créer votre premier projet. Rejoignez l'écosystème de Clever Cloud et bénéficiez d'un déploiement simplifié. Nouveau sur la plateforme ? Essayez nos projets prêts à l'emploi ou contactez-nous pour une assistance personnalisée.`,
  ...
  'cc-homepage-video.link': `Visitez notre chaîne YouTube`,
  'cc-homepage-video.play': `Miniature de la vidéo YouTube Lancer la vidéo`,
  'cc-homepage-video.title': `Regardez nos vidéos`,
  //#endregion
  ...
  'cc-network-group-dashboard.danger-zone.desc': () =>
    sanitize`La suppression de ce Network Group est une action permanente.<br>Les ressources qui en étaient membres seront dissociées et inchangées.`,
  'cc-network-group-dashboard.danger-zone.dialog.confirm-input-label': `Saisissez le nom du Network Group`,
  'cc-network-group-dashboard.danger-zone.dialog.desc': `La suppression de ce Network Group est définitive. Tous ses membres seront dissociés. Avant de continuer, vérifiez que les ressources qui en dépendent (applications appelant un add-on via son nom de domaine NG, peers externes configurés sur le tunnel) ont une autre voie d'accès.`,
  ...
  'cc-network-group-dashboard.delete.error': `Une erreur est survenue pendant la suppression du Network Group`,
  ...
  'cc-network-group-list.cli.content.intro': `Vous pouvez gérer les Network Groups directement depuis votre terminal avec les commandes ci-dessous.`,
  ...
  'cc-network-group-list.cli.content.unlink-command': `Dissocier un Network Group d'une ressource\u00A0:`,
  'cc-network-group-list.create': `Créer un Network Group`,
  'cc-network-group-list.form.button': `Lier au Network Group`,
  'cc-network-group-list.form.description': `Cet écran liste les Network Groups dont cette ressource est membre. Au sein d'un Network Group, la ressource (une application ou un add-on) est joignable par un nom de domaine, et chacune de ses instances devient un pair joignable par une adresse IP. Vous pouvez aussi lier cette ressource à un autre Network Group.`,
  ...
  'cc-network-group-list.list.empty': `Aucun Network Group n'est lié à cette ressource`,
  ...
  'cc-network-group-list.refresh.error': `La ressource a bien été liée au Network Group, mais la liste n'a pas pu être actualisée. Rechargez la page.`,
  'cc-network-group-list.unlink.dialog.desc': `Cette ressource et toutes ses instances seront déconnectées du réseau privé du Network Group. Les autres ressources du groupe ne pourront plus la joindre. Souhaitez-vous continuer\u00A0?`,
  ...
  'cc-network-group-member-card.deleted-member.warning': `Cette ressource a été supprimée. Le membre apparaît toujours dans ce Network Group bien qu'il ne soit plus rattaché à une ressource active. Dissociez-le pour nettoyer le Network Group.`,
  ...
  'cc-network-group-member-list.cli.content.link-member-command': `Lier un membre à un Network Group\u00A0:`,
  ...
  'cc-network-group-member-list.intro': `Un membre est une ressource liée à un Network Group : application, add-on ou ressource externe. Chaque membre est identifié par un nom de domaine dédié au sein du réseau privé. Un pair est une instance de ce membre, avec sa propre adresse IP. Tous les pairs d'un même Network Group communiquent entre eux sur tous les ports, à travers un tunnel WireGuard chiffré.`,
  'cc-network-group-member-list.link-form.button': `Lier le membre`,
  'cc-network-group-member-list.link-form.empty': `Aucune ressource disponible. Toutes vos ressources sont peut-être déjà liées à ce Network Group.`,
  'cc-network-group-member-list.link-form.heading': `Lier un membre`,
  'cc-network-group-member-list.link-form.select-label': `Ressource à lier`,
  'cc-network-group-member-list.member-list.empty': `Aucun membre n'est lié à ce Network Group`,
  'cc-network-group-member-list.member.link.error': `Une erreur est survenue pendant la liaison du membre au Network Group`,
  'cc-network-group-member-list.member.link.success': `Le membre a bien été lié au Network Group`,
  'cc-network-group-member-list.member.logo.a11y-name.external': `Ressource externe`,
  ...
  'cc-network-group-member-list.refresh.error': `L'opération a réussi, mais la liste n'a pas pu être actualisée. Rechargez la page.`,
  ...
  'cc-oauth-consumer-form.create-title': `Nouvel OAuth consumer`,
  'cc-oauth-consumer-form.create.error': `Une erreur est survenue pendant la création de l'OAuth consumer`,
  'cc-oauth-consumer-form.create.success': /** @param {{oauthConsumerName: string}} _ */ ({ oauthConsumerName }) =>
    sanitize`L'OAuth consumer <strong>${oauthConsumerName}</strong> a été créé avec succès`,
  'cc-oauth-consumer-form.danger-zone.description': `Cette action est définitive et ne peut pas être annulée. Une fois l'OAuth consumer supprimé, les utilisateurs ne pourront plus se connecter à l'application via OAuth, et tous les droits accordés seront révoqués.`,
  'cc-oauth-consumer-form.danger-zone.title': `Supprimer l'OAuth consumer`,
  'cc-oauth-consumer-form.delete-button': `Supprimer`,
  'cc-oauth-consumer-form.delete.error': `Une erreur est survenue pendant la suppression de l'OAuth consumer`,
  'cc-oauth-consumer-form.delete.success': `L'OAuth consumer a été supprimé avec succès`,
  ...
  'cc-oauth-consumer-form.load.error': `Une erreur est survenue pendant le chargement des informations de l'OAuth consumer`,
  ...
  'cc-oauth-consumer-form.rights.description': `L'OAuth consumer demandera les droits suivants\u00A0:`,
  ...
  'cc-oauth-consumer-form.update-title': `Mettre à jour votre OAuth consumer`,
  'cc-oauth-consumer-form.update.error': /** @param {{oauthConsumerName: string}} _ */ ({ oauthConsumerName }) =>
    sanitize`Une erreur est survenue pendant la mise à jour de l'OAuth consumer <strong>(${oauthConsumerName})</strong>`,
  'cc-oauth-consumer-form.update.success': /** @param {{oauthConsumerName: string}} _ */ ({ oauthConsumerName }) =>
    sanitize`L'OAuth consumer <strong>(${oauthConsumerName})</strong> a été mis à jour avec succès`,
  //#endregion
  //#region cc-oauth-consumer-info
  'cc-oauth-consumer-info.access.title': `Détails de configuration`,
  'cc-oauth-consumer-info.error': `Une erreur est survenue pendant le chargement des informations de l'OAuth consumer`,
  'cc-oauth-consumer-info.info.base-url': `URL de base de l'application`,
  'cc-oauth-consumer-info.info.description': `Votre application est configurée pour ces URLs et a besoin des informations d'identification suivantes pour utiliser l'OAuth consumer\u00A0:`,
  ...
  'cc-oauth-consumer-info.rights.description': `L'OAuth consumer demandera aux utilisateurs de l'application les droits suivants\u00A0:`,
  ...
  'cc-postgresql-admin.connections.count': /** @param {{count: number}} _ */ ({ count }) =>
    `Il y a actuellement ${formatNumber(lang, count)} ${plural(count, 'connexion')} à votre base de données.`,
  'cc-postgresql-admin.connections.error': `Le nombre de connexions à votre base de données n'a pas pu être récupéré.`,
  'cc-postgresql-admin.connections.kill': `Fermer toutes les connexions`,
  'cc-postgresql-admin.connections.kill.confirm.desc': `Les applications connectées à cette base de données vont perdre leur connexion et peuvent planter. Elles devront se reconnecter.`,
  'cc-postgresql-admin.connections.kill.confirm.heading': `Fermer toutes les connexions ?`,
  'cc-postgresql-admin.connections.kill.desc': `Fermez toutes les connexions en cours à votre base de données. Si une application est en cours d'exécution, cela peut la faire planter.`,
  'cc-postgresql-admin.connections.kill.error': `Une erreur est survenue pendant la fermeture des connexions à votre base de données.`,
  'cc-postgresql-admin.connections.kill.success': `Les connexions à votre base de données ont été fermées.`,
  'cc-postgresql-admin.connections.loading': `Récupération du nombre de connexions à votre base de données...`,
  'cc-postgresql-admin.connections.title': `Connexions`,
  'cc-postgresql-admin.danger-zone': `Zone de danger`,
  'cc-postgresql-admin.direct-host.desc': `Générez le nom d'hôte et le port direct de cet add-on. Les variables d'environnement correspondantes sont ajoutées aux applications qui lui sont liées.`,
  'cc-postgresql-admin.direct-host.error': `Une erreur est survenue pendant la génération du nom d'hôte et du port direct.`,
  'cc-postgresql-admin.direct-host.generate': `Générer un nom d'hôte et un port direct`,
  'cc-postgresql-admin.direct-host.success': `Le nom d'hôte et le port direct ont été générés.`,
  'cc-postgresql-admin.direct-host.title': `Accès direct`,
  'cc-postgresql-admin.error': `Une erreur est survenue pendant le chargement de l'administration de votre base de données.`,
  'cc-postgresql-admin.extension.activate': `Activer l'extension`,
  'cc-postgresql-admin.extension.desc': () =>
    sanitize`Activez une extension PostgreSQL sur votre base de données. Les extensions disponibles sont listées dans notre <cc-link href="${getDocUrl('/addons/postgresql/#default-extensions')}">documentation</cc-link>. Sur les plans dédiés, toutes les extensions listées sont déjà activées.`,
  'cc-postgresql-admin.extension.error': /** @param {{extension: string}} _ */ ({ extension }) =>
    `Une erreur est survenue pendant l'activation de l'extension « ${extension} ».`,
  'cc-postgresql-admin.extension.input': `Nom de l'extension`,
  'cc-postgresql-admin.extension.success': /** @param {{extension: string}} _ */ ({ extension }) =>
    `L'extension « ${extension} » a été activée.`,
  'cc-postgresql-admin.extension.title': `Extensions`,
  'cc-postgresql-admin.loading': `Chargement de l'administration de votre base de données...`,
  'cc-postgresql-admin.password.desc': `Générez un nouveau mot de passe pour votre base de données. Vous devrez redéployer vos applications pour qu'elles l'utilisent.`,
  'cc-postgresql-admin.password.reset': `Générer un nouveau mot de passe`,
  'cc-postgresql-admin.password.reset.confirm.desc': `Le mot de passe actuel est invalidé immédiatement. Les applications continuent de l'utiliser jusqu'à leur redéploiement et ne pourront pas se reconnecter d'ici là.`,
  'cc-postgresql-admin.password.reset.confirm.heading': `Générer un nouveau mot de passe ?`,
  'cc-postgresql-admin.password.reset.error': `Une erreur est survenue pendant la génération d'un nouveau mot de passe.`,
  'cc-postgresql-admin.password.reset.success': `Un nouveau mot de passe a été généré.`,
  'cc-postgresql-admin.password.title': `Mot de passe`,
  'cc-postgresql-admin.promote': `Promouvoir`,
  'cc-postgresql-admin.promote.confirm.desc': `Le lien de réplication est supprimé et ne peut pas être rétabli. Cette base de données devient un serveur indépendant en lecture-écriture.`,
  'cc-postgresql-admin.promote.confirm.heading': `Promouvoir en serveur autonome ?`,
  'cc-postgresql-admin.promote.desc': `Supprimez le lien de réplication et promouvez cette base de données en serveur autonome en lecture-écriture.`,
  'cc-postgresql-admin.promote.error': `Une erreur est survenue pendant la promotion de votre base de données.`,
  'cc-postgresql-admin.promote.success': `Votre base de données a été promue en serveur autonome.`,
  'cc-postgresql-admin.promote.title': `Promouvoir en serveur autonome`,
  'cc-postgresql-admin.read-only-users.create': `Créer un utilisateur en lecture seule`,
  'cc-postgresql-admin.read-only-users.create.error': `Une erreur est survenue pendant la création d'un utilisateur en lecture seule.`,
  'cc-postgresql-admin.read-only-users.create.success': `Un utilisateur en lecture seule a été créé.`,
  'cc-postgresql-admin.read-only-users.desc': `Les utilisateurs en lecture seule ont un accès en lecture à votre base de données, et rien de plus.`,
  'cc-postgresql-admin.read-only-users.password': `Mot de passe`,
  'cc-postgresql-admin.read-only-users.title': `Utilisateurs en lecture seule`,
  'cc-postgresql-admin.read-only-users.user': `Utilisateur`,
  'cc-postgresql-admin.reboot': `Redémarrer les instances`,
  'cc-postgresql-admin.reboot.confirm.desc': `La base de données est indisponible pendant le redémarrage. N'utilisez cette action qu'en dernier recours, après avoir consulté notre page de statut.`,
  'cc-postgresql-admin.reboot.confirm.heading': `Redémarrer les instances ?`,
  'cc-postgresql-admin.reboot.desc': () =>
    sanitize`Redémarrez les instances de votre base de données si elles ne répondent plus. C'est une action de dernier recours : consultez d'abord la <cc-link href="https://www.clevercloudstatus.com/">page de statut de Clever Cloud</cc-link> et, en cas de doute, contactez le support.`,
  'cc-postgresql-admin.reboot.error': `Une erreur est survenue pendant le redémarrage des instances de votre base de données.`,
  'cc-postgresql-admin.reboot.success': `Les instances de votre base de données redémarrent.`,
  'cc-postgresql-admin.replication.desc': () =>
    sanitize`Besoin de réplicas pour plus de performance ou de disponibilité ? Jusqu'à 2 serveurs de secours en lecture seule peuvent être mis en place pour cette base de données. Plus d'informations dans notre <cc-link href="${getDocUrl('/addons/postgresql/#replication')}">documentation</cc-link>.`,
  'cc-postgresql-admin.replication.title': `Réplication`,
  'cc-postgresql-admin.reset': `Réinitialiser la base de données`,
  'cc-postgresql-admin.reset.confirm.desc': `Toutes les tables de la base de données sont supprimées et les données qu'elles contiennent sont perdues. Les sauvegardes sont conservées.`,
  'cc-postgresql-admin.reset.confirm.heading': `Réinitialiser la base de données ?`,
  'cc-postgresql-admin.reset.desc': `Supprimez toutes les tables de votre base de données. Vos sauvegardes sont conservées.`,
  'cc-postgresql-admin.reset.error': `Une erreur est survenue pendant la réinitialisation de votre base de données.`,
  'cc-postgresql-admin.reset.success': `Votre base de données a été réinitialisée.`,
  'cc-postgresql-admin.title': `Administration de la base de données`,
  //#endregion
  ...
  'cc-postgresql-notices.end-of-life.desc': /** @param {{version: string, eolDate: string}} _ */ ({
    ...
    sanitize`PostgreSQL ${version} est en fin de vie depuis le ${formatDateOnly(eolDate)}. Nous vous invitons à migrer vers une version plus récente : plus d'informations sur la <cc-link href="https://www.postgresql.org/support/versioning/">politique de versions de PostgreSQL</cc-link> et sur la <cc-link href="${getDocUrl('/administrate/database-migration')}">migration de base de données</cc-link>.`,
  'cc-postgresql-notices.end-of-life.heading': `Version en fin de vie`,
  'cc-postgresql-notices.missing-credentials.desc': `Cette base de données a été créée avant notre système d'add-ons actuel, quand les utilisateurs et mots de passe n'étaient pas conservés. Contactez le support pour les faire apparaître ici : nous aurons besoin soit des identifiants utilisés par vos applications, soit de générer un nouveau mot de passe, ce qui invalidera l'actuel.`,
  'cc-postgresql-notices.missing-credentials.heading': `Identifiants indisponibles`,
  'cc-postgresql-notices.quota-exceeded.desc': `Votre base de données est en lecture seule car elle dépasse le quota de son plan. Supprimez des données ou migrez vers un plan supérieur. Une fois sous le quota, l'accès en écriture est rétabli en moins de 2 minutes.`,
  'cc-postgresql-notices.quota-exceeded.heading': `Mode lecture seule`,
  //#endregion
