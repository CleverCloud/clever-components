...
export const translations = {
  ...
  'cc-session-tokens.revoke-all-tokens.error': `Une erreur est survenue pendant la révocation de toutes les sessions.`,
  'cc-session-tokens.revoke-all-tokens.partial-error': `Une erreur est survenue pendant la révocation de toutes les sessions. Seules certaines sessions ont été révoquées avec succès.`,
