...
export const translations = {
  ...
  'cc-oauth-consumer-form.danger-zone.description': `La suppression de cet OAuth Consumer est définitive et ne peut pas être annulée. Une fois supprimé, les utilisateurs ne pourront plus se connecter à votre application via OAuth, et toutes les autorisations accordées seront révoquées.`,
  'cc-oauth-consumer-form.danger-zone.title': /** @param {{oauthConsumerName: string}} _ */ ({ oauthConsumerName }) =>
    sanitize`Supprimer consumer oAuth <strong>(${oauthConsumerName})</strong>`,
  ...
  'cc-oauth-consumer-form.go-back-link': `Revenir en arrière`,
  'cc-oauth-consumer-form.info.base-url': `URL de base de l'application`,
  'cc-oauth-consumer-form.info.description': `Ces détails permettront d'identifier votre application et d'assurer une intégration cohérente.`,
  'cc-oauth-consumer-form.info.description-input': `Description de votre application`,
  'cc-oauth-consumer-form.info.homepage-url': `Page d'accueil de l'application`,
  'cc-oauth-consumer-form.info.image': `Image de l'application`,
  'cc-oauth-consumer-form.info.name': `Nom de votre application`,
  'cc-oauth-consumer-form.info.placeholder': `Aucune valeur pour l'instant...`,
  'cc-oauth-consumer-form.info.title': `Informations principales`,
  'cc-oauth-consumer-form.info.url.error': `Saisissez une URL valide. Exemple: https://example.com`,
  'cc-oauth-consumer-form.reset-button': `Réinitialiser les changements`,
  ...
  'cc-oauth-consumer-form.rights.description': `Ces permissions détermineront les actions que vos utilisateurs pourront effectuer via l’OAuth et les données auxquelles l'application pourra accéder.`,
  ...
  'cc-oauth-consumer-form.title': `Nouveau Consumer OAuth`,
  'cc-oauth-consumer-form.update-button': `Sauvegarder les changements`,
