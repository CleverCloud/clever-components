...
export const translations = {
  ...
  'cc-ticket-center.button.remove': `Remove`,
  ...
  'cc-ticket-center.button.attach-file': `Inclure un fichier…`,
  'cc-ticket-center.button.open-ticket': `Créer le ticket`,
  'cc-ticket-center.author-avatar': `Avatar`,
  'cc-ticket-center.input.ids': `Identifiants (app_xxx|postgresql_xxx|mysql_xxx|…)`,
  'cc-ticket-center.input.message': `Votre message`,
  'cc-ticket-center.input.category': `Catégorie`,
