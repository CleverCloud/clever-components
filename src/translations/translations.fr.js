...
export const translations = {
  ...
  'cc-grafana-info.enable-description': `L'activation de grafana créera et fournira les accès à une organisation Grafana pour afficher les métriques des runtimes et des modules complémentaires des applications de l'organisation Clever Cloud.`,
  'cc-grafana-info.enable-description.warning': `Si vous êtes déjà connecté à Grafana, vous devrez vous déconnecter/vous reconnecter pour voir cette organisation.`,
  ...
  'cc-grafana-info.grafana-link-description.warning': `Si vous venez d'activer ce Grafana, vous devrez vous déconnecter/vous reconnecter pour voir cette organisation.`,
  ...
  'cc-grafana-info.screenshot.addon.alt': `Capture d'écran du tableau de bord des modules complémentaires d'applications de Grafana`,
  'cc-grafana-info.screenshot.addon.description': () => sanitize`<div class="test"> Cette tableau de bord comprend plusieurs tuiles présentant les métriques des modules complémentaires des applications Clever Cloud. </div> <br> Il fournit d'abord un panneau de présentation contenant les données du serveur telles que <strong> le cpu, la mémoire, les disques et le réseau</strong>. <br> Un second panneau présente la base de données, et contient des données uniquement pour les modules <strong> MySQL, PostgreSQL, MongoDB et redis</strong>. <br> Ce panneau fournira des informations comme <strong> le nombre de connexions, de requêtes ou de transactions, d'erreurs ou de blocages ou encore d'opérations "tuples"<strong>.`,
  'cc-grafana-info.screenshot.addon.title': `Aperçu du tableau de bord des modules complémentaires d'applications`,
  'cc-grafana-info.screenshot.organisation.alt': `Capture d'écran du tableau de bord des organisations de Grafana`,
  'cc-grafana-info.screenshot.organisation.description': () => sanitize`Ce tableau de bord comprend plusieurs graphiques pour une organisation Clever Cloud. <br> Il fournit un graphique résumant le nombre de <strong>runtimes et de modules complémentaires</strong> d'applications déployés. Il contient également des informations comme le nombre d'applications <strong>par type</strong> ou <strong>par "flavor"</strong>. <br> Un <strong>graphique d'état</strong> affiche un état pour tous les déploiements effectués au cours de l'intervalle de temps Grafana écoulé. <br> Et enfin, c'est possible de récupérerer des <strong>liens globaux et spécifiques</strong> (triés par nombre de requêtes) pour accéder au tableau de bord des runtimes ou des modules des applications.`,
  'cc-grafana-info.screenshot.organisation.title': `Aperçu du tableau de bord des organisations`,
  'cc-grafana-info.screenshot.runtime.alt': `Capture d'écran du tableau de bord des runtimes des applications de Grafana`,
  'cc-grafana-info.screenshot.runtime.description': () => sanitize`Ce tableau de bord comprend un <strong>panneau de présentation</strong> pour obtenir des informations rapides sur une application, ainsi que plusieurs panneaux sur les métriques des runtimes des applications Clever Cloud. <br> Il fournit un graphique reprenant l'état de <strong>l'utilisation de la mémoire, des disques, du processeur, de la charge et du réseau</strong>. <br> Pour chacun groupe de métriques, le panneau contient des tuiles comme des graphe d'utilisations, des jauges ou encore un indicateur de remplissage (basé sur le résultat d'une prédiction linéaire effectuée sur les données de l'intervalle de temps fixé dans Grafana). <br> Cet indicateur donne la durée attendue avant que les métriques ne dépassent 90%.`,
  'cc-grafana-info.screenshot.runtime.title': `Aperçu du tableau de bord des runtimes des applications`,
  //#endregion
