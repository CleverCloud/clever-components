...
export const translations = {
  ...
  'cc-oauth-consumer-form.danger-zone.description': `La suppression de ce consumer OAuth est définitive et ne peut pas être annulée. Une fois supprimé, les utilisateurs ne pourront plus se connecter à l'application via OAuth, et tous les droits accordés seront révoqués.`,
  ...
  'cc-oauth-consumer-form.info.base-url.help': `L'URL de base qui sera utilisée pour les redirections OAuth.`,
  'cc-oauth-consumer-form.info.description': `Le consumer OAuth requiert les détails de l'application afin de pouvoir rediriger les utilisateurs correctement.`,
  'cc-oauth-consumer-form.info.description-input': `Description`,
  'cc-oauth-consumer-form.info.description.help': `Cette description sera affichée à tous les utilisateurs de votre application.`,
  'cc-oauth-consumer-form.info.homepage-url': `Page d'accueil`,
  'cc-oauth-consumer-form.info.homepage-url.help': `L'URL complète de la page d'accueil de votre application.`,
  'cc-oauth-consumer-form.info.image': `URL du logo`,
  'cc-oauth-consumer-form.info.image.help': `Cette image sera affichée aux utilisateurs lors des demandes d'autorisation pour faciliter la reconnaissance de votre service.`,
  'cc-oauth-consumer-form.info.name': `Nom`,
  'cc-oauth-consumer-form.info.name.help': `Un nom que les utilisateurs reconnaîtront et en qui ils auront confiance.`,
  ...
  'cc-oauth-consumer-form.rights.description': `Le consumer OAuth demandera aux utilisateurs de l'application les droits suivants :`,
