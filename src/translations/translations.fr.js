...
export const translations = {
  ...
  'cc-addon-credentials-beta.get-kubeconfig': () =>
    sanitize`<cc-link download="#">Télécharger le fichier Kubeconfig</cc-link>`,
  ...
  'cc-addon-credentials-content.code.config-file': `Fichier de configuration`,
  ...
  'cc-addon-credentials-content.code.external-api-server-url': `URL du serveur API externe`,
