...
import { CcKvStringValueChangeEvent } from './cc-kv-string-editor.events.js';
...
export class CcKvStringEditor extends LitElement {
  ...
  _onFormSubmit(formData) {
    ...
    this.dispatchEvent(new CcKvStringValueChangeEvent(String(formData.value)));
  }
  ...
  render() {
    ...
    return html`<form ${formSubmit(this._onFormSubmit)}>
      <cc-input-text
        ...
        .value=${this._value}
        @cc-text-change=${this._onValueInput}
      ></cc-input-text>
      <div class="buttons">
