  ...
  items: [
    {
      state: {
        type: 'loaded',
        deploymentsInfo: [deploymentInfo('OK', 'DEPLOY', { minutes: 2 }, '7dba2548-8c9e-4219-ba0a-b386839cb34b')],
      },
    },
    {
      state: {
  ...
  items: [
    {
      state: {
        type: 'loaded',
        deploymentsInfo: [deploymentInfo('OK', 'DEPLOY', { seconds: 2 }, 'bf697ecf-c6a1-4ff6-9bd8-b296b27a4bb1')],
      },
    },
    {
      state: {
  ...
  items: [
    {
      state: {
        type: 'loaded',
        deploymentsInfo: [deploymentInfo('OK', 'UNDEPLOY', { seconds: 3 }, 'dcbae659-89af-4bad-b494-c92ba940b284')],
      },
    },
    {
      state: {
  ...
  items: [
    {
      state: {
        type: 'loaded',
        deploymentsInfo: [deploymentInfo('FAIL', 'DEPLOY', { seconds: 4 }, '5b0afb71-ffc2-4bde-82a4-e8851eeffb53')],
      },
    },
    {
      state: {
