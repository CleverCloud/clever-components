...
export class CcAddonAdmin extends LitElement {
  ...
  constructor() {
    ...
    this._conformDeletionFormRef = createRef();
  ...
  updated(changedProperties) {
    ...
    if (wasDeleting && isNotDeleting) {
      this._confirmDeletionDialogRef.value.close();
      this._conformDeletionFormRef.value.reset();
    }
  }
  ...
  _renderDeleteConfirmationDialog(addonName, isDeleting) {
    ...
    return html`
      ...
      >
        ...
        <form class="dialog-form" ${formSubmit(this._onDeleteSubmit.bind(this))} ${ref(this._conformDeletionFormRef)}>
          <cc-input-text
