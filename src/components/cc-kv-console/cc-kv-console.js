...
/**
 * A component displaying a console for interacting with kv database.
 *
 * The history of commands is kept in memory and user can navigate through history using arrow keys.
 *
