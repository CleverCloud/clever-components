...
/**
 * @typedef {import('./cc-grafana-info.types.d.ts').GrafanaErrorType} GrafanaErrorType
 * @typedef {import('./cc-grafana-info.types.d.ts').GrafanaStatusType} GrafanaStatusType
 * @typedef {import('./cc-grafana-info.types.d.ts').GrafanaWaitingType} GrafanaWaitingType
 */
