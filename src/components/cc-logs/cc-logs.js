    ...
    return [
      ...
      css`
        ...
        .select_button {
          ...
          cursor: pointer;
          display: flex;
          /* Buttons get their font size from the user agent, not from their parent. Without this, the em unit of
             --gutter-size resolves against that fixed size, and the gutter stops following the log text. */
          font-size: inherit;
