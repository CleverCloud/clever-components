...
import '../cc-pricing-table/cc-pricing-table.js';
...
/**
 * @typedef {import('./cc-pricing-product.types.d.ts').ActionType} ActionType
 * @typedef {import('./cc-pricing-product.types.d.ts').Currency} Currency
 * @typedef {import('./cc-pricing-product.types.d.ts').Feature} Feature
 * @typedef {import('./cc-pricing-product.types.d.ts').Plan} Plan
 * @typedef {import('./cc-pricing-product.types.d.ts').Temporality} Temporality
 */
