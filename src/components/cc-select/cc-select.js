 ...
 */
export class CcSelect extends CcInputElement {
  ...
  constructor () {
    ...
    /** @type {string|null} Sets the `value` to set when englobing `<form>` element is reset. */
    this.resetValue = '';
      ...
      validationSettingsProvider: () => (
        {
          ...
          validator: this.required ? new RequiredValidator() : null,
        }
      ),
