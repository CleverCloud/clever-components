  ...
  static get styles() {
    return [
      ...
      css`
        ...
        .body-wrapper ::slotted([slot='body']) {
          flex: 1 1 auto;
        }

        .body-wrapper .icon-mode {
          flex: 0 0 auto;
        }
        /* endregion */
        ...
        .icon-mode--radio {
          ...
          /* allows the icon staying centered with the text even if multiline */
          align-items: center;
          display: flex;
          height: 1lh;
        ...
        :host([selected]) ::slotted([slot='footer']) {
          background-color: var(--cc-color-bg-primary-weak, #cedcff);
        }

        :host([selected]) .icon-mode--radio {
          --cc-icon-color: var(--cc-color-bg-primary, #3569aa);
        }

        :host(:not([selected])) .icon-mode--check {
          visibility: hidden;
        }
        /* endregion */
        ...
        :host([disabled]) ::slotted([slot='footer']) {
          background-color: var(--cc-color-bg-neutral, #f5f5f5);
        }

        :host([disabled]) .icon-mode--radio {
        ...
        :host([selected][disabled]) ::slotted([slot='footer']) {
          background-color: var(--cc-color-bg-primary-weaker, #e6eff8);
        }

        :host([selected][disabled]) .icon-mode {
