...
---
# 💡 Smart `<cc-addon-info smart-mode="config-provider">`

## ℹ️ Details

<table>
<tr><td><strong>Component    </strong> <td><a href="🛠-addons-cc-addon-info--default-story"><code>&lt;cc-addon-info&gt;</code></a>
<tr><td><strong>Selector     </strong> <td><code>cc-addon-info[smart-mode="config-provider"]</code>
...
<cc-smart-container context='{
  ...
  <cc-addon-info smart-mode="config-provider"></cc-addon-info>
</cc-smart-container>
```
