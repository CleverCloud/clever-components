 ...
 * @typedef {import('./cc-addon-info.types.js').MetabaseOperatorInfo} MetabaseOperatorInfo
...
class Api {
   ...
   * @param {string} realId
   * @returns {Promise<MetabaseOperatorInfo>}
   */
  ...
  /**
   * @return {Promise<{addonInfo: RawAddon, operator: MetabaseOperatorInfo, operatorVersionInfo: OperatorVersionInfo, grafanaAppLink: string}>}
   */
  async getAddonInfo() {
