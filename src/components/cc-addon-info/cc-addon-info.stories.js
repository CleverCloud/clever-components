  ...
  items: [
    {
      ...
      innerHTML: `
        <p slot="billing">Materia KV uses our next generation of serverless distributed database, synchronously-replicated. Free of charge during testing phases, it will be available on a pay-as-you-go flexible pricing. Develop with ease, it's compatible with third-party protocols, such as Redis: <a href="${getDocUrl('/doc/addons/materia-kv')}">learn more.</a></p>
`,
    },
    {
      /** @type {AddonInfoStateLoading} */
