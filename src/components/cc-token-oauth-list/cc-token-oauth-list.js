 ...
 *
 * @fires {CustomEvent<void>} cc-token-oauth-list:revoke-all-oauth-tokens - Dispatched when a user requests to revoke all tokens
 * @fires {CustomEvent<string>} cc-token-oauth-list:revoke-oauth-token - Dispatched when a user requests to revoke a specific token, with the token ID as payload
 */
export class CcTokenOauthList extends LitElement {
  ...
  _onRevokeAllOauthTokens() {
    dispatchCustomEvent(this, 'revoke-all-oauth-tokens');
  }
