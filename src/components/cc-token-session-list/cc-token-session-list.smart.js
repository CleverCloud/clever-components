 ...
 * @typedef {import('./cc-token-session-list.types.js').RawSessionTokenData} RawSessionTokenData
...
class Api {
   ...
   *
   * @returns {Promise<RawSessionTokenData[]>} A promise that resolves to an array of formatted session tokens
   */
  getSessionTokens() {
    return getAllTokens()
