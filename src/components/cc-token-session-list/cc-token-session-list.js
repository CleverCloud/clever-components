...
import { CcTokenSessionRevokeEvent, CcTokensSessionRevokeAllEvent } from './cc-token-session-list.events.js';
...
export class CcTokenSessionList extends LitElement {
   ...
   */
  _onRevokeAllTokens() {
    this.dispatchEvent(new CcTokensSessionRevokeAllEvent());
  }
  ...
  _onRevokeToken(tokenId) {
    this.dispatchEvent(new CcTokenSessionRevokeEvent(tokenId));
  }
