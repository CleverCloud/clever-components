...
export class CcKvSetExplorer extends LitElement {
  ...
  _onFilterFormSubmit(formData) {
    ...
    this.dispatchEvent(new CcKvSetFilterChangeEvent(formData.pattern));
  }

  /**
   * @param {{element: string}} formData
   */
  _onAddFormSubmit(formData) {
    ...
    this.dispatchEvent(new CcKvSetElementAddEvent(formData.element));
  }
...
customElements.define('cc-kv-set-explorer-beta', CcKvSetExplorer);
