 ...
 * @import { CcBreadcrumbs } from '../cc-breadcrumbs/cc-breadcrumbs.js'
  ...
  _onDrawerFocusLost() {
    if (this.state.type === 'loaded') {
      if (this.state.objects.length > 0) {
        ...
        this._breadcrumbsRef.value?.focus();
      }
    }
  }
        ...
        ? html`<div class="details-wrapper">
            ...
            <div class="details-actions">
              <cc-button
                outlined
                .icon=${iconDownload}
                @cc-click=${() => this._onDownloadObject(object.key)}
                .waiting=${object.state === 'downloading'}
                .disabled=${object.state !== 'idle' && object.state !== 'downloading'}
                >${i18n('cc-cellar-object-list.details.actions.download.button')}</cc-button
              >
              <cc-button
                danger
                outlined
