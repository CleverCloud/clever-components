...
---
# 💡 Smart `<cc-addon-credentials-beta smart-mode="kubernetes">`
...
<tr><td><strong>Selector     </strong> <td><code>cc-addon-credentials-beta[smart-mode="kubernetes"]</code>
...
| `POST`   | `/v4/addon-providers/addon-kubernetes/addons/{realId}/networkgroup`      | Default |
| `DELETE` | `/v4/addon-providers/addon-kubernetes/addons/{realId}/networkgroup`      | Default |
...
<cc-smart-container context='{
  ...
  <cc-addon-credentials-beta smart-mode="kubernetes"></cc-addon-credentials-beta>
</cc-smart-container>
```
