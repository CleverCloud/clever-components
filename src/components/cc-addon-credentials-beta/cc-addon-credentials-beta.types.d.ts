...
export type CcAddonCredentialsBetaState =
  | CcAddonCredentialsBetaStateLoading
  | CcAddonCredentialsBetaStateError
  | CcAddonCredentialsBetaStateLoaded;

export interface CcAddonCredentialsBetaStateLoading {
  type: 'loading';
  tabs: Tabs;
}

export interface CcAddonCredentialsBetaStateLoaded {
  type: 'loaded';
  tabs: Tabs;
}

export interface CcAddonCredentialsBetaStateError {
  type: 'error';
}
