...
import { CcRequestSubmitEvent } from '../common.events.js';
import { CcTagsChangeEvent, CcTextChangeEvent } from './cc-input-text.events.js';
...
export class CcInputText extends CcFormControlElement {
  ...
  _onInput(e) {
    ...
    this.dispatchEvent(new CcTextChangeEvent(this.value));
    if (this._tagsEnabled) {
