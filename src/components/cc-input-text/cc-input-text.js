...
import { CompositeValidator, EmailValidator, RequiredValidator } from '../../lib/form/validation.js';
 ...
 */
export class CcInputText extends CcInputElement {
      ...
      validationSettingsProvider: () => (
        {
          ...
          validator: CompositeValidator.builder()
            ...
            .add(this.type === 'email' ? new EmailValidator() : null)
            .build(),
        }
      ),
