  ...
  list: [
    {
      ...
      restoreCommand:
        'curl -XPOST -u 8H8bO5XGeWAZgA https://r3sdepwtxlpso2jbbhho-elasticsearch.services.clever-cloud.com/_snapshot/cc-s3-repository/2019-11-17-03-00/_restore',
      deleteCommand:
        'curl -XPOST -u 8H8bO5XGeWAZgA https://r3sdepwtxlpso2jbbhho-elasticsearch.services.clever-cloud.com/_snapshot/cc-s3-repository/2019-11-17-03-00/_delete',
    ...
    },
    {
      ...
      restoreCommand:
        'curl -XPOST -u 8H8bO5XGeWAZgA https://r3sdepwtxlpso2jbbhho-elasticsearch.services.clever-cloud.com/_snapshot/cc-s3-repository/2019-11-18-03-30/_restore',
      deleteCommand:
        'curl -XPOST -u 8H8bO5XGeWAZgA https://r3sdepwtxlpso2jbbhho-elasticsearch.services.clever-cloud.com/_snapshot/cc-s3-repository/2019-11-18-03-30/_delete',
    ...
    },
    {
      ...
      restoreCommand:
        'curl -XPOST -u 8H8bO5XGeWAZgA https://r3sdepwtxlpso2jbbhho-elasticsearch.services.clever-cloud.com/_snapshot/cc-s3-repository/2019-11-19-03-00/_restore',
      deleteCommand:
        'curl -XPOST -u 8H8bO5XGeWAZgA https://r3sdepwtxlpso2jbbhho-elasticsearch.services.clever-cloud.com/_snapshot/cc-s3-repository/2019-11-19-03-00/_delete',
    ...
    },
    {
      ...
      restoreCommand:
        'curl -XPOST -u 8H8bO5XGeWAZgA https://r3sdepwtxlpso2jbbhho-elasticsearch.services.clever-cloud.com/_snapshot/cc-s3-repository/2019-11-20-03-00/_restore',
      deleteCommand:
        'curl -XPOST -u 8H8bO5XGeWAZgA https://r3sdepwtxlpso2jbbhho-elasticsearch.services.clever-cloud.com/_snapshot/cc-s3-repository/2019-11-20-03-00/_delete',
    ...
    },
    {
      ...
      restoreCommand:
        'curl -XPOST -u 8H8bO5XGeWAZgA https://r3sdepwtxlpso2jbbhho-elasticsearch.services.clever-cloud.com/_snapshot/cc-s3-repository/2019-11-21-03-00/_restore',
      deleteCommand:
        'curl -XPOST -u 8H8bO5XGeWAZgA https://r3sdepwtxlpso2jbbhho-elasticsearch.services.clever-cloud.com/_snapshot/cc-s3-repository/2019-11-21-03-00/_delete',
    },
  ],
};
...
const backupsOldElasticsearch = {
  ...
  restoreCommand:
    'curl -XPOST https://my-old-service.services.clever-cloud.com/_snapshot/cc_backup_repository/snapshot_1/_restore',
  list: [
    {
      createdAt: new Date('2019-11-17 03:00'),
  ...
  list: [
    {
      ...
      restoreCommand:
        'pg_restore -h buet68oyeprz5tlhcdvn-postgresql.services.clever-cloud.com -p 1204 -U ug6icxp9f2mtjmxbtons -d buet68oyeprz5tlhcdvn --format=c YOUR_BACKUP_FILE',
      deleteCommand: null,
    },
    {
  ...
  list: [
    {
      ...
      restoreCommand:
        'mysql -h buet68oyeprz5tlhcdvn-mysql.services.clever-cloud.com -P 1204 -u ug6icxp9f2mtjmxbtons -p buet68oyeprz5tlhcdvn < YOUR_BACKUP_FILE',
      deleteCommand: null,
    },
    {
      createdAt: new Date('2020-12-24T02:02:03.006Z'),
  ...
  list: [
    {
      ...
      restoreCommand:
        'mongorestore --host=buet68oyeprz5tlhcdvn-mongodb.services.clever-cloud.com --port=1204 --username=ug6icxp9f2mtjmxbtons --nsFrom="buet68oyeprz5tlhcdvn.*" --nsTo="buet68oyeprz5tlhcdvn.*" --authenticationDatabase=buet68oyeprz5tlhcdvn --archive=YOUR_BACKUP_FILE --gzip',
      deleteCommand: null,
    },
    {
      createdAt: new Date('2020-12-24T02:02:03.006Z'),
  ...
  items: [
    {
      backups: {
        ...
        list: [...backupsMysql.list, ...backupsMysql.list, ...backupsMysql.list, ...backupsMysql.list],
      },
    },
  ],
});
  ...
  items: [
    {
      backups: {
        ...
        list: [...backupsMongodb.list, ...backupsMongodb.list, ...backupsMongodb.list, ...backupsMongodb.list],
      },
    },
  ],
});
  ...
  items: [
    {
      backups: {
        ...
        list: [...backupsRedis.list, ...backupsRedis.list, ...backupsRedis.list, ...backupsRedis.list],
      },
    },
  ],
});
  ...
  items: [
    {
      backups: {
        ...
        list: [...backupsJenkins.list, ...backupsJenkins.list, ...backupsJenkins.list, ...backupsJenkins.list],
      },
    },
  ],
});
