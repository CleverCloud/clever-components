  ...
  onContextUpdate({ context, onEvent, updateComponent, signal }) {
    ...
    api
      ...
      .then((cellarEndpoint) => {
        ...
        /**
         * @param {(list: CellarExplorerItemsListStateBucketsLoaded) => void} fn
         */
        function updateBucketListState(fn) {
          updateComponent(
            'state',
        ...
        /**
         * @param {Partial<CellarItemStateBucketDetails>} newBucketDetailsState
         */
        function updateBucketDetails(newBucketDetailsState) {
          updateBucketListState((list) => {
            if (list.details != null) {
              list.details = { ...list.details, ...newBucketDetailsState };
            }
          });
        }
        ...
        onEvent('cc-cellar-bucket-show', (bucketName) => {
          updateBucket(bucketName, { state: 'fetching' });
          cellarClient
        ...
        onEvent('cc-cellar-bucket-delete', (bucketName) => {
          updateBucketDetails({ state: 'deleting' });
          cellarClient
            ...
            .catch((error) => {
              ...
              updateBucketDetails({ state: 'idle' });
