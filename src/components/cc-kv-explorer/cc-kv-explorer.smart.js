...
defineSmartComponent({
   ...
   */
  async onContextUpdate({ component, context, onNewEvent, updateComponent, signal }) {
    ...
    onNewEvent('cc-kv-filter-change', async ({ type, pattern }) => {
      try {
    ...
    onNewEvent('cc-kv-keys-refresh', async () => {
      try {
    ...
    onNewEvent('cc-kv-load-more-keys', async () => {
      try {
    ...
    onNewEvent('cc-kv-selected-key-change', async (key) => {
    ...
    onNewEvent('cc-kv-key-delete', async (key) => {
      try {
    ...
    onNewEvent('cc-kv-key-add', async (keyValue) => {
      try {
    ...
    onNewEvent('cc-kv-string-value-change', async (value) => {
    ...
    onNewEvent('cc-kv-hash-filter-change', async (pattern) => {
    ...
    onNewEvent('cc-kv-hash-load-more', async () => {
      const editorCtrl = /** @type {KvKeyEditorHashCtrl} */ (detailsCtrl.editorCtrl);
    ...
    onNewEvent('cc-kv-hash-element-delete', async (field) => {
      const editorCtrl = /** @type {KvKeyEditorHashCtrl} */ (detailsCtrl.editorCtrl);
    ...
    onNewEvent('cc-kv-hash-element-update', async ({ field, value }) => {
      const editorCtrl = /** @type {KvKeyEditorHashCtrl} */ (detailsCtrl.editorCtrl);
    ...
    onNewEvent('cc-kv-hash-element-add', async ({ field, value }) => {
      const editorCtrl = /** @type {KvKeyEditorHashCtrl} */ (detailsCtrl.editorCtrl);
    ...
    onNewEvent('cc-kv-list-filter-change', async (index) => {
    ...
    onNewEvent('cc-kv-list-load-more', async () => {
      const editorCtrl = /** @type {KvKeyEditorListCtrl} */ (detailsCtrl.editorCtrl);
    ...
    onNewEvent('cc-kv-list-element-update', async ({ index, value }) => {
      const editorCtrl = /** @type {KvKeyEditorListCtrl} */ (detailsCtrl.editorCtrl);
    ...
    onNewEvent('cc-kv-list-element-add', async ({ position, value }) => {
      const editorCtrl = /** @type {KvKeyEditorListCtrl} */ (detailsCtrl.editorCtrl);
    ...
    onNewEvent('cc-kv-set-filter-change', async (pattern) => {
    ...
    onNewEvent('cc-kv-set-load-more', async () => {
      const editorCtrl = /** @type {KvKeyEditorSetCtrl} */ (detailsCtrl.editorCtrl);
    ...
    onNewEvent('cc-kv-set-element-delete', async (element) => {
      const editorCtrl = /** @type {KvKeyEditorSetCtrl} */ (detailsCtrl.editorCtrl);
    ...
    onNewEvent('cc-kv-set-element-add', async (element) => {
      const editorCtrl = /** @type {KvKeyEditorSetCtrl} */ (detailsCtrl.editorCtrl);
    ...
    onNewEvent('cc-kv-terminal-command-send', async (commandLine) => {
