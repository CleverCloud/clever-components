 ...
 * @typedef {import('./cc-kv-explorer.types.d.ts').CcKvExplorerDetailStateEditSet} CcKvExplorerDetailStateEditSet
 * @typedef {import('./cc-kv-explorer.types.d.ts').CcKvKey} CcKvKey
 * @typedef {import('./kv-client.js').KvClient} KvClient
 * @typedef {import('../cc-kv-set-explorer/cc-kv-set-explorer.types.d.ts').CcKvSetExplorerStateLoaded} CcKvSetExplorerStateLoaded
 * @typedef {import('../cc-kv-set-explorer/cc-kv-set-explorer.types.d.ts').CcKvSetElementState} CcKvSetElementState
 * @typedef {import('../cc-kv-set-explorer/cc-kv-set-explorer.types.d.ts').CcKvSetExplorerState} CcKvSetExplorerState
 * @typedef {import('../cc-kv-set-explorer/cc-kv-set-explorer.types.d.ts').CcKvSetExplorerAddFormState} CcKvSetExplorerAddFormState
 */
...
export class KvSetKeyController {
  ...
  /**
   * @param {string} value
   * @param {'idle'|'deleting'} state
   */
  updateEditorElementState(value, state) {
