 ...
 * @typedef {import('./cc-kv-explorer.types.d.ts').CcKvExplorerDetailStateEditHash} CcKvExplorerDetailStateEditHash
 * @typedef {import('./cc-kv-explorer.types.d.ts').CcKvKey} CcKvKey
 * @typedef {import('./kv-client.js').KvClient} KvClient
 * @typedef {import('../cc-kv-hash-explorer/cc-kv-hash-explorer.types.d.ts').CcKvHashExplorerStateLoaded} CcKvHashExplorerStateLoaded
 * @typedef {import('../cc-kv-hash-explorer/cc-kv-hash-explorer.types.d.ts').CcKvHashElementState} CcKvHashElementState
 * @typedef {import('../cc-kv-hash-explorer/cc-kv-hash-explorer.types.d.ts').CcKvHashExplorerState} CcKvHashExplorerState
 * @typedef {import('../cc-kv-hash-explorer/cc-kv-hash-explorer.types.d.ts').CcKvHashExplorerAddFormState} CcKvHashExplorerAddFormState
 */
...
export class KvHashKeyController {
   ...
   */
  updateEditorElementState(field, state) {
