...
/**
 * @typedef {import('./cc-kv-hash-explorer.types.d.ts').CcKvHashExplorerState} CcKvHashExplorerState
 * @typedef {import('./cc-kv-hash-explorer.types.d.ts').CcKvHashElementState} CcKvHashElementState
...
export class CcKvHashExplorer extends LitElement {
  ...
  /**
   * @param {Event & {target: {dataset: {field: string}}}} e
   */
  ...
  render() {
    ...
    const getElementId = (e) => e.state.field;
      ...
      <div class="wrapper">
        <form class="top-bar" ${formSubmit(this._onFilterFormSubmit)}>
          ...
          <cc-button type="submit" .icon=${iconFilter} hide-text outlined ?disabled=${isLoading}
            >${i18n('cc-kv-hash-explorer.filter.apply')}</cc-button
          >
        </form>
  ...
  _renderElement(state, skeleton) {
    ...
    const firstButton = isEditing
      ...
      : {
          ...
          label: i18n('cc-kv-hash-explorer.element.edit.start'),
          outlined: true,
          primary: true,
          danger: false,
          waiting: false,
    ...
    const secondBtn = isEditing
      ...
      : {
          ...
          label: i18n('cc-kv-hash-explorer.element.delete'),
          outlined: true,
          primary: false,
          danger: true,
    ...
    return html`<div class="element">
      ...
      ${state.type === 'editing' || state.type === 'updating'
        ? html`
            ...
            ></cc-input-text>
          `
        : html`<span class=${classMap({ 'element-value': true, skeleton: skeleton })}>${state.value}</span>`}
      <cc-button
      ...
      <cc-button
        ...
        >${i18n('cc-kv-hash-explorer.element.copy')}</cc-button
      >
    </div>`;
  }
