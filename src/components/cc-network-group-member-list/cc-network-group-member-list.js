    ...
    return html`
      <cc-block>
        ...
        <cc-block-details slot="footer-left">
          ...
          <div slot="content">
            <p>
              ${i18n('cc-network-group-member-list.cli.content.intro')}
              ${i18n('cc-network-group-member-list.cli.content.instruction')}
            </p>
            <dl>
    ...
    return html`
      ...
      >
        ...
        <cc-dialog-confirm-actions
          ...
          @cc-confirm="${() => {
            if (memberIdToUnlink != null) {
              this._onUnlinkMember(memberIdToUnlink);
            }
          }}"
          ?waiting="${isUnlinking}"
        >
        ...
        <div slot="content">
          ...
          ${state.type === 'idle' && !hasOptions
            ? html`
              ...
              `
            : ''}
          ${isLoading || isLinking || (state.type === 'idle' && hasOptions)
            ? html`
