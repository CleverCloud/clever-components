...
const PROJECT_SKELETON_NUMBER = 5;
    ...
    const projects =
      this.state.type === 'loaded'
        ...
        : /** @type {TemplateProject[]} */ (
            new Array(PROJECT_SKELETON_NUMBER).fill({ name: fakeString(10), description: fakeString(40), href: '' })
          );

    return html`
      <div class="wrapper ${classMap({ skeleton })}">
  ...
  static get styles() {
    return [
      ...
      css`
        ...
        .wrapper.skeleton .project-list {
          pointer-events: none;
        }

        .wrapper.skeleton .project-name,
        .wrapper.skeleton .project-description {
