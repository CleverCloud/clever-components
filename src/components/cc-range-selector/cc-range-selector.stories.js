...
export const partiallyDisabled = makeStory(conf, {
  items: [
    ...
    },
    {
      ...
      innerHTML: `
        <p slot="help">Default value ending before disabled options</p>
      `,
    },
    {
      ...DEFAULT_SELECTOR_RANGE,
      ...
      innerHTML: `
        <p slot="help">Default value starting after disabled options</p>
      `,
    },
    {
      ...DEFAULT_SELECTOR_RANGE,
      ...
      innerHTML: `
        <p slot="help">Default value ending with the disabled options</p>
      `,
    },
    {
      ...DEFAULT_SELECTOR_RANGE,
      ...
      innerHTML: `
        <p slot="help">Default value starting with the disabled options</p>
      `,
    },
  ],
});
