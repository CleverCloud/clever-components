...
/**
 * A component to display information about a network group peer (ID, public key, IP address, and type).
...
export class CcNetworkGroupPeerCard extends LitElement {
  ...
  constructor() {
    ...
    this.peer = { id: '', label: '', publicKey: '', ip: '', type: 'CleverPeer' };
  }
    ...
    return [
      ...
      css`
        ...
        .config-download-link {
          ...
          display: flex;
          flex: 0 0 auto;
          height: var(--config-link-icon-size);
          justify-content: center;
          width: var(--config-link-icon-size);
        }
      `,
    ];
  }
