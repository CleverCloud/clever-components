 ...
 * dispatched once the API has answered. Consumers deriving something from the domain list (the console's "open"
 * link, for instance) can safely refetch when they receive it.
 *
 * @extends {CcEvent}
 */
