...
defineSmartComponent({
  ...
  onContextUpdate({ component, context, onEvent, updateComponent, signal }) {
    ...
    /**
     * Adding or removing a domain can change what the API reports as primary, so the list is
     * refetched instead of being patched locally. An application may legitimately have no primary
     * domain at all.
     *
