...
defineSmartComponent({
  ...
  onContextUpdate({ context, onNewEvent, updateComponent, signal }) {
    ...
    onNewEvent('cc-domain-add', ({ hostname, pathPrefix, isWildcard }) => {
    ...
    onNewEvent('cc-domain-delete', ({ id, hostname, pathPrefix, isWildcard }) => {
      const domainWithPathAndWildcard = getHostWithWildcard(hostname + pathPrefix, isWildcard);
    ...
    onNewEvent('cc-domain-mark-as-primary', ({ id, hostname, pathPrefix, isWildcard }) => {
      const domainWithPathAndWildcard = getHostWithWildcard(hostname + pathPrefix, isWildcard);
      updateDomain(id, (domainState) => {
