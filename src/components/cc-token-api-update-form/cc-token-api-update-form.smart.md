...
|------------------------|----------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `cc-token-has-changed` | `string` | Fired when the token has been modified successfully.<br/>Should be used to redirect the user to another page. The payload contains the `id` of the token that has changed. |
