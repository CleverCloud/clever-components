...
import { CcKvTerminalCommandSendEvent, CcKvTerminalStateChangeEvent } from './cc-kv-terminal.events.js';
  ...
  _onShellPromptKeyDown(e) {
    ...
    if (e.key === 'Enter' && !isCommandRunning) {
      ...
      if (isStringBlank(commandLine)) {
        ...
        this.dispatchEvent(new CcKvTerminalCommandSendEvent(commandLine));
        e.target.value = '';
      }
