...
/**
 * @typedef {import('./cc-pricing-table.types.d.ts').ActionType} ActionType
 * @typedef {import('./cc-pricing-table.types.d.ts').Currency} Currency
 * @typedef {import('./cc-pricing-table.types.d.ts').Feature} Feature
 * @typedef {import('./cc-pricing-table.types.d.ts').Plan} Plan
 * @typedef {import('./cc-pricing-table.types.d.ts').Temporality} Temporality
 */
