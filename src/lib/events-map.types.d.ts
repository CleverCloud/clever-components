...
import {
  CcTokenSessionRevokeEvent,
  CcTokensSessionRevokeAllEvent,
} from '../components/cc-token-session-list/cc-token-session-list.events.js';
import { CcClickEvent, CcRequestSubmitEvent, CcToggleEvent } from '../components/common.events.js';
...
declare global {
  ...
  interface GlobalEventHandlersEventMap {
    ...
    'cc-token-session-revoke': CcTokenSessionRevokeEvent;
    'cc-tokens-session-revoke-all': CcTokensSessionRevokeAllEvent;
  }
}
