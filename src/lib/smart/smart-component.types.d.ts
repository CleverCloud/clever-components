...
export type OnEventCallback = <ThisEventType extends keyof HTMLElementEventMap>(
  type: ThisEventType,
  listener: (
    detail: HTMLElementEventMap[ThisEventType] extends CustomEvent<infer ThisDetail> ? ThisDetail : never,
  ) => void,
) => void;
