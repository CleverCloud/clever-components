...
import { CcClickEvent, CcMultiSelectEvent, CcRequestSubmitEvent, CcToggleEvent } from '../components/common.events.js';
...
declare global {
  ...
  class CcChangeEvent<T extends string = string> extends CcEvent<T> {}
