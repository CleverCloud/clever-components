...
import { CcInputElement } from "./cc-input-element";
...
export type DescribedInputElement = { native: true, element: NativeInputElement } | { native: false, element: CcInputElement };
