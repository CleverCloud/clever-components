 ...
 * @typedef {import('./validation.types.js').CompositeValidatorsBuilder} CompositeValidatorsBuilder
 ...
 * Validation is short-circuited at first invalid validator.
 *
 * @implements {Validator}
 */
export class CompositeValidator {
  /**
   * Helps combining multiple validators.
   *
   * @return {CompositeValidatorsBuilder}
   */
  static builder () {
    /** @type {Array<Validator>} */
    const validators = [];
    /** @type {CompositeValidatorsBuilder} */
    const builder = {
      add (validator) {
        if (validator != null) {
