...
/** @import { CcDialog } from "../../components/cc-dialog/cc-dialog.js"; */
 ...
 * @param {HTMLElement} container
 * @param {CcDialogConfirmForm['tagName']|CcDialogConfirmActions['tagName']} componentSelector
...
export function getDialogHandlers(container, componentSelector) {
  ...
  const onConfirm = () => {
    ...
    const component = /** @type {CcDialogConfirmForm|CcDialogConfirmActions|null} */ (
