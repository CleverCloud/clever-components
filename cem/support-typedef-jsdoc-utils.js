...
export function getTypesFromClass (classNode, ts, retrievePrivate = false) {
  ...
  if (constructor != null) {
    result.push(...getTypesFromConstructor(constructor, ts, retrievePrivate));
  }
  result.push(...getTypesFromEventTags(classNode, ts));
...
const BUILTIN_TYPES = ['String', 'Boolean', 'Number', 'BigInt', 'Date', 'Map', 'Set', 'WeakMap', 'WeakSet', 'Object'];
