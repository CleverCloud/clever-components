...
We only had a custom ESLint plugin to sort our CSS declarations but that was pretty much it as referenced in [ADR 11](📌-architecture-decision-records-adr-0011-sorting-css-declarations--docs).
