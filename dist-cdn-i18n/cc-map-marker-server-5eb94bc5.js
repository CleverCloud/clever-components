import{s as e,b as t,i}from"./lit-element-98ed46d4.js";class r extends e{static get properties(){return{anchor:{type:Array},size:{type:Array},state:{type:String,reflect:!0},tooltip:{type:Array}}}constructor(){super(),this.anchor=[16,32],this.size=[32,32],this.state="default",this.tooltip=[0,-32]}render(){return t`
    ...
    `}static get styles(){return[i`
      ...
      `]}}window.customElements.define("cc-map-marker-server",r);export{r as CcMapMarkerServer};
