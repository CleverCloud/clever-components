import i18nAlwaysArrowWithSanitize from '../i18n-always-arrow-with-sanitize.js';
import i18nAlwaysSanitizeWithHtml from '../i18n-always-sanitize-with-html.js';
import i18nAlwaysTemplateLiteralSanitize from '../i18n-always-template-literal-sanitize.js';
import i18nNoParamlessArrow from '../i18n-no-paramless-arrow.js';
import i18nNoSanitizeWithoutHtml from '../i18n-no-sanitize-without-html.js';
import i18nOrder from '../i18n-order.js';
import i18nValidKey from '../i18n-valid-key.js';
import i18nValidValue from '../i18n-valid-value.js';
