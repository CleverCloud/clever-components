...
const REQUESTS_COUNTS_BIG = [596600, 219080, 165930, 124350, 98820, 89510, 108320, 310880, 97549, 63093, 112781, 120270];
const REQUESTS_COUNTS_SMALL = [895, 2, 78, 95, 630, 3966, 2190, 1659, 988, 1127, 1202, 1243];
const REQUESTS_COUNTS_SIMILAR = [220024, 220132, 220088, 220248, 220242, 220101, 220092, 220011, 220736, 220521, 220098, 220881];
...
storiesOf('2. Overview|<cc-tile-requests>', module)
  .addParameters({ notes })
  ...
  .add('different settings (data & widths)', () => {
    return createContainer([
