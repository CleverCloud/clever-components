...
describe('XML parsing', () => {
  ...
  it('parses correctly', async () => {
    ...
    expect(firstItem.description).to.deep.equal(
    ...
    expect(firstItem.link).to.deep.equal(
    ...
    expect(secondItem.description).to.deep.equal(
    ...
    expect(thirdItem.description).to.deep.equal(
