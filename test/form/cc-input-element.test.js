...
import { CcInputElement } from '../../src/lib/form/cc-input-element.js';
import { invalid, VALID, ValidValidator } from '../../src/lib/form/validation.js';
...
describe('InputElement', () => {
  ...
  it('should fallback to code when error message map does know the error code', async () => {
    const input = await getInputElement({
      validationSettingsProvider: () => ({
        errorMessages: {},
        validator: {
  ...
  it('should use customValidator and built-in validator', async () => {
    ...
    input.element.customValidator = customValidator;
    await elementUpdated(input.element);
